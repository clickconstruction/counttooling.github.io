...
- `app.js` publishes the shared surface near its tail
  ...
  `getPageScale`, `getPageSheetAnalysis`, `STANDARD_SHEETS`,
  `sheetCorrectionFactor`, `scaleCheckDelta`, `convertUnitValue`,
  `formatFeetInchesFromVal`, `resetScaleCheckMode`, `showSetScaleFirstToast`, `getLineModifiers`,
