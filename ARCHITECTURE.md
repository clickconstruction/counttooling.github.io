...
- L611 - [sync] Checkout probe, hashing & PDF cache
- L773 - Math & Format Helpers
- L1562 - Coordinate Helpers
- L1570 - PDF render bitmap cache
- L1737 - PDF Rendering
- L3191 - UI Render Functions
- L4338 - Inline rename & polyline edit mode
- L4452 - Modal primitives (showModal / hideModal)
- L4471 - Toasts & line color picker
- L4525 - Airboard cloud sync
- L4558 - Supabase RPC & presence heartbeat
- L4598 - User activity / event telemetry
- L4641 - Supabase auth & dev auth
- L4770 - [sync] Checkout subscription & permission refresh
- L4780 - Modals & Handlers
- L4853 - PDF intake (upload, test PDF, hashing)
- L5181 - Toolbar tool buttons
- L5289 - Tool sidebar buttons & legend overlay
- L5403 - Add Line Type modal
- L5473 - Line color & sidebar handlers
- L5615 - Polyline modal & drawing
- L5646 - Zoom bar & page navigation
- L5672 - Export canvas JSON
- L5688 - PDF download helpers
- L5697 - View-link URL helpers & show-highlights/notes
- L5769 - Custom icon upload handler
- L5779 - Export & report dropdown menus
- L5869 - Sidebar drawer toggles
- L5880 - Mobile actions burger menu pointer & header logo
- L5892 - User Activity pointer (format.js + features/user-activity.js)
- L5904 - My Settings pointer (features/my-settings.js)
- L5927 - Auth & settings entry buttons
  - L5972 - Project Settings checkout & Save Status bell
  - L6073 - [sync] Checkout expired recovery
  - L6129 - [sync] Turn In
  - L6408 - Share modal pointer & copy-project openers
  - L6439 - Settings menu actions
  - L6460 - Auth sign-in form
  - L6484 - Save Project modal
  - L6497 - Checkout expired recovery modal wiring
  - L6602 - Last-session restore prompt
  - L6681 - Canvas Repair modal wiring
- L6826 - Canvas Event Handlers
- L7198 - Event Binding
- L7208 - Aim loupe (mobile press-hold precise placement)
- L7346 - Zoom transform preview & commit
- L7382 - Canvas mouse, wheel & touch handlers
- L8003 - Global dropdown dismissal & keyboard hotkeys
- L8231 - [sync] Manual save to cloud
- L8241 - [sync] Auto-save
- L8248 - [sync] Local backup (IndexedDB takeoff state)
- L8381 - [sync] Checkout keep-alive
- L8395 - App feature registry
- L8576 - View-only mode
- L8582 - Init / boot
