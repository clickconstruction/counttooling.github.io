...
- L333 - State
- L481 - [sync] Sync recovery & client recycle
- L532 - [sync] Global force reload
- L615 - [sync] Save Status log & envelope
- L628 - [sync] Dirty tracking & local session reset
- L634 - Undo/redo stacks
- L801 - [sync] Checkout probe, hashing & PDF cache
- L963 - Math & Format Helpers
- L1752 - Coordinate Helpers
- L1760 - PDF render bitmap cache
- L1927 - PDF Rendering
- L3381 - UI Render Functions
- L4528 - Inline rename & polyline edit mode
- L4642 - Modal primitives (showModal / hideModal)
- L4661 - Toasts & line color picker
- L4715 - Airboard cloud sync
- L4748 - Supabase RPC & presence heartbeat
- L4788 - User activity / event telemetry
- L4831 - Supabase auth & dev auth
- L4960 - [sync] Checkout subscription & permission refresh
- L4970 - Modals & Handlers
- L5043 - PDF intake (upload, test PDF, hashing)
- L5371 - Toolbar tool buttons
- L5479 - Tool sidebar buttons & legend overlay
- L5593 - Add Line Type modal
- L5663 - Line color & sidebar handlers
- L5805 - Polyline modal & drawing
- L5836 - Zoom bar & page navigation
- L5862 - Export canvas JSON
- L5878 - PDF download helpers
- L5887 - View-link URL helpers & show-highlights/notes
- L5959 - Custom icon upload handler
- L5969 - Export & report dropdown menus
- L6059 - Sidebar drawer toggles
- L6070 - Mobile actions burger menu pointer & header logo
- L6082 - User Activity pointer (format.js + features/user-activity.js)
- L6094 - My Settings pointer (features/my-settings.js)
- L6117 - Auth & settings entry buttons
  - L6162 - Project Settings checkout & Save Status bell
  - L6263 - [sync] Checkout expired recovery
  - L6319 - [sync] Turn In
  - L6598 - Share modal pointer & copy-project openers
  - L6629 - Settings menu actions
  - L6650 - Auth sign-in form
  - L6674 - Save Project modal
  - L6687 - Checkout expired recovery modal wiring
  - L6792 - Last-session restore prompt
  - L6871 - Canvas Repair modal wiring
- L7016 - Canvas Event Handlers
- L7388 - Event Binding
- L7398 - Aim loupe (mobile press-hold precise placement)
- L7536 - Zoom transform preview & commit
- L7572 - Canvas mouse, wheel & touch handlers
- L8193 - Global dropdown dismissal & keyboard hotkeys
- L8421 - [sync] Manual save to cloud
- L8431 - [sync] Auto-save
- L8438 - [sync] Local backup (IndexedDB takeoff state)
- L8571 - [sync] Checkout keep-alive
- L8585 - App feature registry
- L8766 - View-only mode
- L8772 - Init / boot
