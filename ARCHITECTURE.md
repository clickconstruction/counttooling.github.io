...
- L952 - [sync] Global force reload
- L1072 - [sync] Save Status log & envelope
- L1216 - [sync] Dirty tracking & local session reset
- L1431 - [sync] Checkout probe, hashing & PDF cache
- L1678 - Math & Format Helpers
- L2359 - Coordinate Helpers
- L2371 - PDF Rendering
- L3543 - UI Render Functions
- L4654 - Inline rename & polyline edit mode
- L4768 - Item detail & properties modals
- L5092 - Toasts & line color picker
- L5178 - Airboard cloud sync
- L5211 - Supabase RPC & presence heartbeat
- L5251 - User activity / event telemetry
- L5294 - Supabase auth & dev auth
- L5415 - [sync] Checkout subscription & permission refresh
- L5593 - Modals & Handlers
- L5666 - PDF intake (upload, test PDF, hashing)
- L5991 - Toolbar tool buttons
- L6098 - Tool sidebar buttons & legend overlay
- L6212 - Add Line Type modal
- L6284 - Line color & sidebar handlers
- L6428 - Polyline modal & drawing
- L6459 - Zoom bar & page navigation
- L6498 - Canvas layers
- L6701 - PDF download helpers & PipeTooling menu
- L6776 - Copy summaries (PipeTooling / Email)
- L6911 - Import-canvas-after-PDF & Clear Page modals
- L7087 - Download current page
- L7335 - Zone & page-action modal handlers
- L7445 - User activity time formatting
- L7603 - User Activity modal (admin)
- L7671 - My Settings modal
- L7702 - Auth & settings entry buttons
  - L7745 - Project Settings checkout & Save Status bell
  - L7875 - [sync] Checkout expired recovery
  - L8129 - [sync] Turn In
  - L8631 - Share project & view links
  - L8851 - Cloud project hydrate / copy / fork
  - L9047 - Settings menu actions & Airboard sync
  - L9126 - My Settings password & Auth sign-in
  - L9179 - Save Project modal
  - L9382 - Copy project modal
  - L9406 - Checkout expired recovery modal wiring
  - L9490 - Save-before-load modal
  - L9565 - Last-session restore prompt
  - L9593 - User Activity filters & view toggle
- L9781 - Canvas Event Handlers
- L10125 - Event Binding
- L10878 - [sync] Manual save to cloud
- L11327 - [sync] Auto-save
- L11624 - [sync] Local backup (IndexedDB takeoff state)
- L11841 - [sync] Checkout keep-alive
- L11885 - App feature registry
- L12008 - View-only mode
- L12161 - Init / boot
