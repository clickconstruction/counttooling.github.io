...
|------|------:|------------------|
| [app.js](app.js) | 6,526 | **The remaining monolith** — down from 16.2k (9.9k after save-engine Stage 6, 8.1k after the Tier-2 splits, then −987 from the canvas-draw extraction). The only file worth actively shrinking; the region table below says what's left and in what order. |
...
| [app/index.html](app/index.html) | 2,450 | The shell: HTML structure + every modal, no inline JS. Flat markup with no build step to split it; grows roughly linearly with modal count. Leave. |
...
| `features/*.js` (52 files) | 11,646 total | Healthy: largest after load-project are quick-modals (462), user-activity (459), user-admin (453), room-sizer (443), output (416), scale (412) — each single-feature scoped with its own Playwright spec. Leave. |
...
- L2588 - Toasts & line color picker
- L2642 - Airboard cloud sync
- L2684 - Supabase RPC & presence heartbeat
- L2724 - User activity / event telemetry
- L2767 - Supabase auth & dev auth
- L2899 - [sync] Checkout subscription & permission refresh
- L2909 - Modals & Handlers
- L2977 - PDF intake (upload, test PDF, hashing)
- L2985 - Toolbar tool buttons
- L3111 - Tool sidebar buttons & legend overlay
- L3229 - Add Line Type modal
- L3299 - Line color & sidebar handlers
- L3441 - Polyline modal & drawing
- L3472 - Zoom bar & page navigation
- L3498 - Export canvas JSON
- L3514 - PDF download helpers
- L3523 - View-link URL helpers & show-highlights/notes
- L3595 - Custom icon upload handler
- L3605 - Export & report dropdown menus
- L3694 - Sidebar drawer toggles
- L3705 - Mobile actions burger menu pointer & header logo
- L3717 - User Activity pointer (format.js + features/user-activity.js)
- L3729 - My Settings pointer (features/my-settings.js)
- L3752 - Auth & settings entry buttons
  - L3797 - Project Settings checkout & Save Status bell
  - L3898 - [sync] Checkout expired recovery
  - L3954 - [sync] Turn In
  - L4056 - Share modal pointer & copy-project openers
  - L4087 - Settings menu actions
  - L4108 - Auth sign-in form
  - L4132 - Save Project modal
  - L4145 - Checkout expired recovery modal wiring
  - L4250 - Last-session restore prompt
  - L4257 - Canvas Repair modal wiring
- L4410 - Canvas Event Handlers
- L4800 - Event Binding
- L4810 - Aim loupe (mobile press-hold precise placement)
- L4949 - Zoom transform preview & commit
- L5028 - Canvas mouse, wheel & touch handlers
- L5689 - Global dropdown dismissal & keyboard hotkeys
- L5949 - [sync] Manual save to cloud
- L5959 - [sync] Auto-save
- L5966 - [sync] Local backup (IndexedDB takeoff state)
- L6099 - [sync] Checkout keep-alive
- L6113 - App feature registry
- L6349 - View-only mode
- L6355 - Init / boot
