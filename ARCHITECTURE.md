...
|------|------:|------------------|
| [app.js](app.js) | 7,262 | **The remaining monolith** — down from 16.2k (9.9k after save-engine Stage 6, 8.1k after the Tier-2 splits, then −987 from the canvas-draw extraction). The only file worth actively shrinking; the region table below says what's left and in what order. |
...
| [canvas-draw.js](canvas-draw.js) | 955 | Done — the unified annotation draw core (`createCanvasDraw(deps)` + `drawAnnotationsCore`), node-tested, guarded by [render-pixels.spec.js](render-pixels.spec.js). Both draw paths are thin env-builders over it. |
| [app/index.html](app/index.html) | 2,803 | The shell: HTML structure + every modal, no inline JS. Flat markup with no build step to split it; grows roughly linearly with modal count. Leave. |
| [styles.css](styles.css) | 1,760 | All CSS, token-organized. Leave. |
...
| `features/*.js` (69 files) | 16,150 total | Healthy: largest after load-project are quick-modals (462), user-activity (459), user-admin (453), room-sizer (443), output (416), scale (412) — each single-feature scoped with its own Playwright spec. Leave. |
...
- L1218 - Coordinate Helpers
- L1226 - PDF render bitmap cache
- L1280 - Sharp crop tile (deep-zoom sharpening + window-first commits)
- L1291 - PDF Rendering
- L2062 - UI Render Functions
- L2660 - Inline rename & polyline edit mode
- L2774 - Modal primitives (showModal / hideModal)
- L2805 - Toasts & line color picker
- L2872 - Airboard cloud sync
- L2917 - Supabase RPC & presence heartbeat
- L2957 - User activity / event telemetry
- L3016 - Supabase auth & dev auth
- L3160 - [sync] Checkout subscription & permission refresh
- L3170 - Modals & Handlers
- L3238 - PDF intake (upload, test PDF, hashing)
- L3246 - Toolbar tool buttons
- L3446 - Tool sidebar buttons & legend overlay
- L3537 - Add Line Type modal
- L3620 - Line color & sidebar handlers
- L3829 - Polyline modal & drawing
- L3872 - Zoom bar & page navigation
- L3898 - Export canvas JSON
- L3914 - PDF download helpers
- L3923 - View-link URL helpers & show-highlights/notes
- L3995 - Custom icon upload handler
- L4005 - Export & report dropdown menus
- L4092 - Sidebar drawer toggles
- L4103 - Mobile actions burger menu pointer & header logo
- L4115 - User Activity pointer (format.js + features/user-activity.js)
- L4127 - My Settings pointer (features/my-settings.js)
- L4152 - Auth & settings entry buttons
  - L4197 - Project Settings checkout & Save Status bell
  - L4289 - [sync] Checkout expired recovery
  - L4345 - [sync] Turn In
  - L4454 - Share modal pointer & copy-project openers
  - L4485 - Settings menu actions
  - L4506 - Auth sign-in form
  - L4531 - Save Project modal
  - L4544 - Checkout expired recovery modal wiring
  - L4649 - Last-session restore prompt
  - L4656 - Canvas Repair modal wiring
- L4843 - Canvas Event Handlers
- L5295 - Event Binding
- L5305 - Aim loupe (mobile press-hold precise placement)
- L5455 - Zoom transform preview & commit
- L5534 - Canvas mouse, wheel & touch handlers
- L6286 - Global dropdown dismissal & keyboard hotkeys
- L6579 - [sync] Manual save to cloud
- L6589 - [sync] Auto-save
- L6596 - [sync] Local backup (IndexedDB takeoff state)
- L6729 - [sync] Checkout keep-alive
- L6743 - App feature registry
- L7049 - View-only mode
- L7055 - Init / boot
