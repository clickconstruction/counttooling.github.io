...
|------|------:|------------------|
| [app.js](app.js) | 7,421 | **The remaining monolith** — down from 16.2k (9.9k after save-engine Stage 6, 8.1k after the Tier-2 splits, then −987 from the canvas-draw extraction). The only file worth actively shrinking; the region table below says what's left and in what order. |
...
| [styles.css](styles.css) | 1,729 | All CSS, token-organized. Leave. |
...
| `features/*.js` (68 files) | 16,064 total | Healthy: largest after load-project are quick-modals (462), user-activity (459), user-admin (453), room-sizer (443), output (416), scale (412) — each single-feature scoped with its own Playwright spec. Leave. |
...
- L1221 - Coordinate Helpers
- L1229 - PDF render bitmap cache
- L1283 - Sharp crop tile (deep-zoom sharpening + window-first commits)
- L1294 - PDF Rendering
- L2054 - UI Render Functions
- L2676 - Inline rename & polyline edit mode
- L2790 - Modal primitives (showModal / hideModal)
- L2821 - Toasts & line color picker
- L2889 - Airboard cloud sync
- L2934 - Supabase RPC & presence heartbeat
- L2974 - User activity / event telemetry
- L3033 - Supabase auth & dev auth
- L3219 - [sync] Checkout subscription & permission refresh
- L3229 - Modals & Handlers
- L3297 - PDF intake (upload, test PDF, hashing)
- L3305 - Toolbar tool buttons
- L3505 - Tool sidebar buttons & legend overlay
- L3596 - Add Line Type modal
- L3679 - Line color & sidebar handlers
- L3888 - Polyline modal & drawing
- L3931 - Zoom bar & page navigation
- L3957 - Export canvas JSON
- L3973 - PDF download helpers
- L3982 - View-link URL helpers & show-highlights/notes
- L4054 - Custom icon upload handler
- L4064 - Export & report dropdown menus
- L4151 - Sidebar drawer toggles
- L4182 - Mobile actions burger menu pointer & header logo
- L4194 - User Activity pointer (format.js + features/user-activity.js)
- L4206 - My Settings pointer (features/my-settings.js)
- L4231 - Auth & settings entry buttons
  - L4290 - Project Settings checkout & Save Status bell
  - L4382 - [sync] Checkout expired recovery
  - L4438 - [sync] Turn In
  - L4547 - Share modal pointer & copy-project openers
  - L4578 - Settings menu actions
  - L4599 - Auth sign-in form
  - L4624 - Save Project modal
  - L4637 - Checkout expired recovery modal wiring
  - L4742 - Last-session restore prompt
  - L4749 - Canvas Repair modal wiring
- L4936 - Canvas Event Handlers
- L5388 - Event Binding
- L5398 - Aim loupe (mobile press-hold precise placement)
- L5548 - Zoom transform preview & commit
- L5627 - Canvas mouse, wheel & touch handlers
- L6379 - Global dropdown dismissal & keyboard hotkeys
- L6721 - [sync] Manual save to cloud
- L6731 - [sync] Auto-save
- L6738 - [sync] Local backup (IndexedDB takeoff state)
- L6871 - [sync] Checkout keep-alive
- L6885 - App feature registry
- L7200 - View-only mode
- L7206 - Init / boot
