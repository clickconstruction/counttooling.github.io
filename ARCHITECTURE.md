...
- L2759 - Supabase RPC & presence heartbeat
- L2799 - User activity / event telemetry
- L2842 - Supabase auth & dev auth
- L2974 - [sync] Checkout subscription & permission refresh
- L2984 - Modals & Handlers
- L3052 - PDF intake (upload, test PDF, hashing)
- L3060 - Toolbar tool buttons
- L3173 - Tool sidebar buttons & legend overlay
- L3263 - Add Line Type modal
- L3348 - Line color & sidebar handlers
- L3526 - Polyline modal & drawing
- L3557 - Zoom bar & page navigation
- L3583 - Export canvas JSON
- L3599 - PDF download helpers
- L3608 - View-link URL helpers & show-highlights/notes
- L3680 - Custom icon upload handler
- L3690 - Export & report dropdown menus
- L3777 - Sidebar drawer toggles
- L3788 - Mobile actions burger menu pointer & header logo
- L3800 - User Activity pointer (format.js + features/user-activity.js)
- L3812 - My Settings pointer (features/my-settings.js)
- L3835 - Auth & settings entry buttons
  - L3880 - Project Settings checkout & Save Status bell
  - L3981 - [sync] Checkout expired recovery
  - L4037 - [sync] Turn In
  - L4139 - Share modal pointer & copy-project openers
  - L4170 - Settings menu actions
  - L4191 - Auth sign-in form
  - L4215 - Save Project modal
  - L4228 - Checkout expired recovery modal wiring
  - L4333 - Last-session restore prompt
  - L4340 - Canvas Repair modal wiring
- L4493 - Canvas Event Handlers
- L4887 - Event Binding
- L4897 - Aim loupe (mobile press-hold precise placement)
- L5036 - Zoom transform preview & commit
- L5115 - Canvas mouse, wheel & touch handlers
- L5776 - Global dropdown dismissal & keyboard hotkeys
- L6038 - [sync] Manual save to cloud
- L6048 - [sync] Auto-save
- L6055 - [sync] Local backup (IndexedDB takeoff state)
- L6188 - [sync] Checkout keep-alive
- L6202 - App feature registry
- L6460 - View-only mode
- L6466 - Init / boot
