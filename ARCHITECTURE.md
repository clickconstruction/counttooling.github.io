...
- L377 - [sync] Global force reload
- L460 - [sync] Save Status log & envelope
- L473 - [sync] Dirty tracking & local session reset
- L479 - Undo/redo stacks
- L593 - [sync] Checkout probe, hashing & PDF cache
- L655 - Math & Format Helpers
- L1288 - Coordinate Helpers
- L1296 - PDF render bitmap cache
- L1587 - Sharp crop tile (deep-zoom sharpening + window-first commits)
- L1740 - PDF Rendering
- L2386 - UI Render Functions
- L3463 - Inline rename & polyline edit mode
- L3577 - Modal primitives (showModal / hideModal)
- L3596 - Toasts & line color picker
- L3650 - Airboard cloud sync
- L3683 - Supabase RPC & presence heartbeat
- L3723 - User activity / event telemetry
- L3766 - Supabase auth & dev auth
- L3895 - [sync] Checkout subscription & permission refresh
- L3905 - Modals & Handlers
- L3973 - PDF intake (upload, test PDF, hashing)
- L3981 - Toolbar tool buttons
- L4107 - Tool sidebar buttons & legend overlay
- L4224 - Add Line Type modal
- L4294 - Line color & sidebar handlers
- L4436 - Polyline modal & drawing
- L4467 - Zoom bar & page navigation
- L4493 - Export canvas JSON
- L4509 - PDF download helpers
- L4518 - View-link URL helpers & show-highlights/notes
- L4590 - Custom icon upload handler
- L4600 - Export & report dropdown menus
- L4690 - Sidebar drawer toggles
- L4701 - Mobile actions burger menu pointer & header logo
- L4713 - User Activity pointer (format.js + features/user-activity.js)
- L4725 - My Settings pointer (features/my-settings.js)
- L4748 - Auth & settings entry buttons
  - L4793 - Project Settings checkout & Save Status bell
  - L4894 - [sync] Checkout expired recovery
  - L4950 - [sync] Turn In
  - L5215 - Share modal pointer & copy-project openers
  - L5246 - Settings menu actions
  - L5267 - Auth sign-in form
  - L5291 - Save Project modal
  - L5304 - Checkout expired recovery modal wiring
  - L5409 - Last-session restore prompt
  - L5416 - Canvas Repair modal wiring
- L5567 - Canvas Event Handlers
- L5957 - Event Binding
- L5967 - Aim loupe (mobile press-hold precise placement)
- L6106 - Zoom transform preview & commit
- L6185 - Canvas mouse, wheel & touch handlers
- L6846 - Global dropdown dismissal & keyboard hotkeys
- L7081 - [sync] Manual save to cloud
- L7091 - [sync] Auto-save
- L7098 - [sync] Local backup (IndexedDB takeoff state)
- L7231 - [sync] Checkout keep-alive
- L7245 - App feature registry
- L7441 - View-only mode
- L7447 - Init / boot
