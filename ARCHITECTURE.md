...
|------|------:|------------------|
| [app.js](app.js) | 7,442 | **The remaining monolith** — down from 16.2k (9.9k after save-engine Stage 6, 8.1k after the Tier-2 splits, then −987 from the canvas-draw extraction). The only file worth actively shrinking; the region table below says what's left and in what order. |
...
| [app/index.html](app/index.html) | 2,819 | The shell: HTML structure + every modal, no inline JS. Flat markup with no build step to split it; grows roughly linearly with modal count. Leave. |
| [styles.css](styles.css) | 1,780 | All CSS, token-organized. Leave. |
...
| `features/*.js` (69 files) | 16,517 total | Healthy: largest after load-project are quick-modals (462), user-activity (459), user-admin (453), room-sizer (443), output (416), scale (412) — each single-feature scoped with its own Playwright spec. Leave. |
...
- L1228 - Coordinate Helpers
- L1236 - PDF render bitmap cache
- L1290 - Sharp crop tile (deep-zoom sharpening + window-first commits)
- L1301 - PDF Rendering
- L2072 - UI Render Functions
- L2697 - Inline rename & polyline edit mode
- L2811 - Modal primitives (showModal / hideModal)
- L2842 - Toasts & line color picker
- L2910 - Airboard cloud sync
- L2955 - Supabase RPC & presence heartbeat
- L2995 - User activity / event telemetry
- L3054 - Supabase auth & dev auth
- L3240 - [sync] Checkout subscription & permission refresh
- L3250 - Modals & Handlers
- L3318 - PDF intake (upload, test PDF, hashing)
- L3326 - Toolbar tool buttons
- L3526 - Tool sidebar buttons & legend overlay
- L3617 - Add Line Type modal
- L3700 - Line color & sidebar handlers
- L3909 - Polyline modal & drawing
- L3952 - Zoom bar & page navigation
- L3978 - Export canvas JSON
- L3994 - PDF download helpers
- L4003 - View-link URL helpers & show-highlights/notes
- L4075 - Custom icon upload handler
- L4085 - Export & report dropdown menus
- L4172 - Sidebar drawer toggles
- L4203 - Mobile actions burger menu pointer & header logo
- L4215 - User Activity pointer (format.js + features/user-activity.js)
- L4227 - My Settings pointer (features/my-settings.js)
- L4252 - Auth & settings entry buttons
  - L4311 - Project Settings checkout & Save Status bell
  - L4403 - [sync] Checkout expired recovery
  - L4459 - [sync] Turn In
  - L4568 - Share modal pointer & copy-project openers
  - L4599 - Settings menu actions
  - L4620 - Auth sign-in form
  - L4645 - Save Project modal
  - L4658 - Checkout expired recovery modal wiring
  - L4763 - Last-session restore prompt
  - L4770 - Canvas Repair modal wiring
- L4957 - Canvas Event Handlers
- L5409 - Event Binding
- L5419 - Aim loupe (mobile press-hold precise placement)
- L5569 - Zoom transform preview & commit
- L5648 - Canvas mouse, wheel & touch handlers
- L6400 - Global dropdown dismissal & keyboard hotkeys
- L6742 - [sync] Manual save to cloud
- L6752 - [sync] Auto-save
- L6759 - [sync] Local backup (IndexedDB takeoff state)
- L6892 - [sync] Checkout keep-alive
- L6906 - App feature registry
- L7221 - View-only mode
- L7227 - Init / boot
