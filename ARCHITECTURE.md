...
- L343 - State
- L582 - [sync] Sync recovery & client recycle
- L981 - [sync] Global force reload
- L1104 - [sync] Save Status log & envelope
- L1248 - [sync] Dirty tracking & local session reset
- L1463 - [sync] Checkout probe, hashing & PDF cache
- L1710 - Math & Format Helpers
- L2447 - Coordinate Helpers
- L2459 - PDF Rendering
- L3706 - UI Render Functions
- L4828 - Inline rename & polyline edit mode
- L4942 - Item detail & properties modals
- L5266 - Toasts & line color picker
- L5414 - Airboard cloud sync
- L5447 - Supabase RPC & presence heartbeat
- L5487 - User activity / event telemetry
- L5530 - Supabase auth & dev auth
- L5651 - [sync] Checkout subscription & permission refresh
- L5829 - Modals & Handlers
- L5902 - PDF intake (upload, test PDF, hashing)
- L6227 - Toolbar tool buttons
- L6335 - Tool sidebar buttons & legend overlay
- L6449 - Add Line Type modal
- L6519 - Line color & sidebar handlers
- L6663 - Polyline modal & drawing
- L6694 - Zoom bar & page navigation
- L6733 - Canvas layers
- L6936 - PDF download helpers & PipeTooling menu
- L7012 - Copy summaries (PipeTooling / Email)
- L7214 - Import-canvas-after-PDF & Clear Page modals
- L7390 - Download current page
- L7638 - Zone & page-action modal handlers
- L7742 - Mobile actions burger menu (right-side drawer)
- L7870 - User activity time formatting
- L8028 - User Activity modal (admin)
- L8096 - My Settings modal
- L8127 - Auth & settings entry buttons
  - L8172 - Project Settings checkout & Save Status bell
  - L8290 - [sync] Checkout expired recovery
  - L8544 - [sync] Turn In
  - L9057 - Share project & view links
  - L9277 - Cloud project hydrate / copy / fork
  - L9473 - Settings menu actions & Airboard sync
  - L9552 - My Settings password & Auth sign-in
  - L9605 - Save Project modal
  - L9808 - Copy project modal
  - L9832 - Checkout expired recovery modal wiring
  - L9916 - Save-before-load modal
  - L9991 - Last-session restore prompt
  - L10019 - User Activity filters & view toggle
- L10207 - Canvas Event Handlers
- L10576 - Event Binding
- L10579 - Aim loupe (mobile press-hold precise placement)
- L11519 - [sync] Manual save to cloud
- L12144 - [sync] Auto-save
- L12441 - [sync] Local backup (IndexedDB takeoff state)
- L12667 - [sync] Checkout keep-alive
- L12711 - App feature registry
- L12840 - View-only mode
- L12995 - Init / boot
