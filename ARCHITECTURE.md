...
|------|------:|------------------|
| [app.js](app.js) | 7,832 | **The remaining monolith** — down from 16.2k (9.9k after save-engine Stage 6, 8.1k after the Tier-2 splits, then −987 from the canvas-draw extraction). The only file worth actively shrinking; the region table below says what's left and in what order. |
...
- L3865 - Supabase RPC & presence heartbeat
- L3905 - User activity / event telemetry
- L3948 - Supabase auth & dev auth
- L4080 - [sync] Checkout subscription & permission refresh
- L4090 - Modals & Handlers
- L4158 - PDF intake (upload, test PDF, hashing)
- L4166 - Toolbar tool buttons
- L4292 - Tool sidebar buttons & legend overlay
- L4409 - Add Line Type modal
- L4479 - Line color & sidebar handlers
- L4621 - Polyline modal & drawing
- L4652 - Zoom bar & page navigation
- L4678 - Export canvas JSON
- L4694 - PDF download helpers
- L4703 - View-link URL helpers & show-highlights/notes
- L4775 - Custom icon upload handler
- L4785 - Export & report dropdown menus
- L4875 - Sidebar drawer toggles
- L4886 - Mobile actions burger menu pointer & header logo
- L4898 - User Activity pointer (format.js + features/user-activity.js)
- L4910 - My Settings pointer (features/my-settings.js)
- L4933 - Auth & settings entry buttons
  - L4978 - Project Settings checkout & Save Status bell
  - L5079 - [sync] Checkout expired recovery
  - L5135 - [sync] Turn In
  - L5400 - Share modal pointer & copy-project openers
  - L5431 - Settings menu actions
  - L5452 - Auth sign-in form
  - L5476 - Save Project modal
  - L5489 - Checkout expired recovery modal wiring
  - L5594 - Last-session restore prompt
  - L5601 - Canvas Repair modal wiring
- L5754 - Canvas Event Handlers
- L6144 - Event Binding
- L6154 - Aim loupe (mobile press-hold precise placement)
- L6293 - Zoom transform preview & commit
- L6372 - Canvas mouse, wheel & touch handlers
- L7033 - Global dropdown dismissal & keyboard hotkeys
- L7281 - [sync] Manual save to cloud
- L7291 - [sync] Auto-save
- L7298 - [sync] Local backup (IndexedDB takeoff state)
- L7431 - [sync] Checkout keep-alive
- L7445 - App feature registry
- L7655 - View-only mode
- L7661 - Init / boot
