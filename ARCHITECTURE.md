...
|------|------:|------------------|
| [app.js](app.js) | 7,853 | **The remaining monolith** — down from 16.2k (9.9k after save-engine Stage 6, 8.1k after the Tier-2 splits, then −987 from the canvas-draw extraction). The only file worth actively shrinking; the region table below says what's left and in what order. |
...
| [render-worker.spec.js](render-worker.spec.js) | Playwright regression for the render worker — lazy adoption reaches `ready` after boot, a forced cold raster is `workerRastered` with zero fallbacks and real canvas content, page flips work end-to-end, and the `DISABLE_RENDER_WORKER` escape hatch keeps everything main-thread (`mode 'main'`, adoption never kicks). Every other spec exercises the worker path implicitly in Chromium. `npx playwright test render-worker.spec.js` |
...
- L144 - State
- L300 - [sync] Sync recovery & client recycle
- L381 - [sync] Global force reload
- L464 - [sync] Save Status log & envelope
- L467 - [sync] Field-error telemetry
- L517 - [sync] Dirty tracking & local session reset
- L523 - Undo/redo stacks
- L652 - [sync] Checkout probe, hashing & PDF cache
- L714 - Math & Format Helpers
- L1347 - Coordinate Helpers
- L1355 - PDF render bitmap cache
- L1704 - Sharp crop tile (deep-zoom sharpening + window-first commits)
- L1999 - PDF Rendering
- L2646 - UI Render Functions
- L3640 - Inline rename & polyline edit mode
- L3754 - Modal primitives (showModal / hideModal)
- L3773 - Toasts & line color picker
- L3827 - Airboard cloud sync
- L3869 - Supabase RPC & presence heartbeat
- L3909 - User activity / event telemetry
- L3952 - Supabase auth & dev auth
- L4084 - [sync] Checkout subscription & permission refresh
- L4094 - Modals & Handlers
- L4162 - PDF intake (upload, test PDF, hashing)
- L4170 - Toolbar tool buttons
- L4296 - Tool sidebar buttons & legend overlay
- L4413 - Add Line Type modal
- L4483 - Line color & sidebar handlers
- L4625 - Polyline modal & drawing
- L4656 - Zoom bar & page navigation
- L4682 - Export canvas JSON
- L4698 - PDF download helpers
- L4707 - View-link URL helpers & show-highlights/notes
- L4779 - Custom icon upload handler
- L4789 - Export & report dropdown menus
- L4879 - Sidebar drawer toggles
- L4890 - Mobile actions burger menu pointer & header logo
- L4902 - User Activity pointer (format.js + features/user-activity.js)
- L4914 - My Settings pointer (features/my-settings.js)
- L4937 - Auth & settings entry buttons
  - L4982 - Project Settings checkout & Save Status bell
  - L5083 - [sync] Checkout expired recovery
  - L5139 - [sync] Turn In
  - L5404 - Share modal pointer & copy-project openers
  - L5435 - Settings menu actions
  - L5456 - Auth sign-in form
  - L5480 - Save Project modal
  - L5493 - Checkout expired recovery modal wiring
  - L5598 - Last-session restore prompt
  - L5605 - Canvas Repair modal wiring
- L5758 - Canvas Event Handlers
- L6148 - Event Binding
- L6158 - Aim loupe (mobile press-hold precise placement)
- L6297 - Zoom transform preview & commit
- L6376 - Canvas mouse, wheel & touch handlers
- L7037 - Global dropdown dismissal & keyboard hotkeys
- L7297 - [sync] Manual save to cloud
- L7307 - [sync] Auto-save
- L7314 - [sync] Local backup (IndexedDB takeoff state)
- L7447 - [sync] Checkout keep-alive
- L7461 - App feature registry
- L7676 - View-only mode
- L7682 - Init / boot
