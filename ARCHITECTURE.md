...
- L378 - State
- L528 - [sync] Sync recovery & client recycle
- L579 - [sync] Global force reload
- L662 - [sync] Save Status log & envelope
- L675 - [sync] Dirty tracking & local session reset
- L681 - Undo/redo stacks
- L848 - [sync] Checkout probe, hashing & PDF cache
- L1010 - Math & Format Helpers
- L1799 - Coordinate Helpers
- L1807 - PDF render bitmap cache
- L1974 - PDF Rendering
- L3428 - UI Render Functions
- L4575 - Inline rename & polyline edit mode
- L4689 - Modal primitives (showModal / hideModal)
- L4708 - Toasts & line color picker
- L4856 - Airboard cloud sync
- L4889 - Supabase RPC & presence heartbeat
- L4929 - User activity / event telemetry
- L4972 - Supabase auth & dev auth
- L5101 - [sync] Checkout subscription & permission refresh
- L5111 - Modals & Handlers
- L5184 - PDF intake (upload, test PDF, hashing)
- L5512 - Toolbar tool buttons
- L5620 - Tool sidebar buttons & legend overlay
- L5734 - Add Line Type modal
- L5804 - Line color & sidebar handlers
- L5948 - Polyline modal & drawing
- L5979 - Zoom bar & page navigation
- L6005 - Export canvas JSON
- L6021 - PDF download helpers
- L6074 - View-link URL helpers & show-highlights/notes
- L6146 - Custom icon upload handler
- L6271 - Export & report dropdown menus
- L6361 - Sidebar drawer toggles
- L6372 - Mobile actions burger menu pointer & header logo
- L6384 - User Activity pointer (format.js + features/user-activity.js)
- L6396 - My Settings pointer (features/my-settings.js)
- L6419 - Auth & settings entry buttons
  - L6464 - Project Settings checkout & Save Status bell
  - L6565 - [sync] Checkout expired recovery
  - L6621 - [sync] Turn In
  - L6900 - Share modal pointer & copy-project openers
  - L6943 - Cloud project hydrate / copy / fork
  - L7140 - Settings menu actions
  - L7161 - Auth sign-in form
  - L7185 - Save Project modal
  - L7388 - Copy project modal
  - L7412 - Checkout expired recovery modal wiring
  - L7496 - Save-before-load modal
  - L7571 - Last-session restore prompt
  - L7650 - Canvas Repair modal wiring
- L7797 - Canvas Event Handlers
- L8169 - Event Binding
- L8179 - Aim loupe (mobile press-hold precise placement)
- L8317 - Zoom transform preview & commit
- L8353 - Canvas mouse, wheel & touch handlers
- L8974 - Global dropdown dismissal & keyboard hotkeys
- L9202 - [sync] Manual save to cloud
- L9212 - [sync] Auto-save
- L9219 - [sync] Local backup (IndexedDB takeoff state)
- L9352 - [sync] Checkout keep-alive
- L9366 - App feature registry
- L9538 - View-only mode
- L9544 - Init / boot
