...
| Copy to /Tooling | `forPipeTooling` or `getPipeToolingSummary` |
...
- **Conditional sidebar visibility** — Show Highlights, Show Notes, Copy to /Tooling, Show Report, Combined PDF hidden when no data
