...
IIFE) lives in [app.js](app.js) (~13.7k lines, slimmed from ~16.2k as the pure
...
> is ~13.7k lines and edits shift them constantly. Navigate by the `// SECTION:`
...
`app.js` is one ~13.7k-line IIFE: `state`, ~50 `let` flags, and ~100 functions
...
- L343 - State
- L571 - [sync] Sync recovery & client recycle
- L914 - [sync] Global force reload
- L1034 - [sync] Save Status log & envelope
- L1170 - [sync] Dirty tracking & local session reset
- L1385 - [sync] Checkout probe, hashing & PDF cache
- L1632 - Math & Format Helpers
- L2313 - Coordinate Helpers
- L2325 - PDF Rendering
- L3497 - UI Render Functions
- L4608 - Inline rename & polyline edit mode
- L4722 - Item detail & properties modals
- L5046 - Toasts & line color picker
- L5132 - Airboard cloud sync
- L5165 - Supabase RPC & presence heartbeat
- L5205 - User activity / event telemetry
- L5248 - Supabase auth & dev auth
- L5369 - [sync] Checkout subscription & permission refresh
- L5537 - Modals & Handlers
- L5610 - PDF intake (upload, test PDF, hashing)
- L5935 - Toolbar tool buttons
- L6042 - Tool sidebar buttons & legend overlay
- L6156 - Add Line Type modal
- L6228 - Line color & sidebar handlers
- L6372 - Polyline modal & drawing
- L6403 - Zoom bar & page navigation
- L6442 - Canvas layers
- L6645 - PDF download helpers & PipeTooling menu
- L6720 - Copy summaries (PipeTooling / Email)
- L6855 - Import-canvas-after-PDF & Clear Page modals
- L7031 - Download current page
- L7279 - Zone & page-action modal handlers
- L7389 - User activity time formatting
- L7547 - User Activity modal (admin)
- L7615 - My Settings modal
- L7646 - Auth & settings entry buttons
  - L7689 - Project Settings checkout & Save Status bell
  - L7819 - [sync] Checkout expired recovery
  - L8073 - [sync] Turn In
  - L8575 - Share project & view links
  - L8795 - Cloud project hydrate / copy / fork
  - L8991 - Settings menu actions & Airboard sync
  - L9070 - My Settings password & Auth sign-in
  - L9123 - Save Project modal
  - L9326 - Copy project modal
  - L9350 - Checkout expired recovery modal wiring
  - L9434 - Save-before-load modal
  - L9509 - Last-session restore prompt
  - L9537 - User Activity filters & view toggle
- L9725 - Canvas Event Handlers
- L10069 - Event Binding
- L10822 - [sync] Manual save to cloud
- L11271 - [sync] Auto-save
- L11568 - [sync] Local backup (IndexedDB takeoff state)
- L11785 - [sync] Checkout keep-alive
- L11829 - App feature registry
- L11952 - View-only mode
- L12105 - Init / boot
