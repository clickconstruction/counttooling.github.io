...
- L2561 - Inline rename & polyline edit mode
- L2675 - Modal primitives (showModal / hideModal)
- L2705 - Toasts & line color picker
- L2759 - Airboard cloud sync
- L2804 - Supabase RPC & presence heartbeat
- L2844 - User activity / event telemetry
- L2887 - Supabase auth & dev auth
- L3019 - [sync] Checkout subscription & permission refresh
- L3029 - Modals & Handlers
- L3097 - PDF intake (upload, test PDF, hashing)
- L3105 - Toolbar tool buttons
- L3240 - Tool sidebar buttons & legend overlay
- L3331 - Add Line Type modal
- L3416 - Line color & sidebar handlers
- L3625 - Polyline modal & drawing
- L3656 - Zoom bar & page navigation
- L3682 - Export canvas JSON
- L3698 - PDF download helpers
- L3707 - View-link URL helpers & show-highlights/notes
- L3779 - Custom icon upload handler
- L3789 - Export & report dropdown menus
- L3876 - Sidebar drawer toggles
- L3887 - Mobile actions burger menu pointer & header logo
- L3899 - User Activity pointer (format.js + features/user-activity.js)
- L3911 - My Settings pointer (features/my-settings.js)
- L3934 - Auth & settings entry buttons
  - L3979 - Project Settings checkout & Save Status bell
  - L4080 - [sync] Checkout expired recovery
  - L4136 - [sync] Turn In
  - L4238 - Share modal pointer & copy-project openers
  - L4269 - Settings menu actions
  - L4290 - Auth sign-in form
  - L4314 - Save Project modal
  - L4327 - Checkout expired recovery modal wiring
  - L4432 - Last-session restore prompt
  - L4439 - Canvas Repair modal wiring
- L4592 - Canvas Event Handlers
- L4992 - Event Binding
- L5002 - Aim loupe (mobile press-hold precise placement)
- L5142 - Zoom transform preview & commit
- L5221 - Canvas mouse, wheel & touch handlers
- L5882 - Global dropdown dismissal & keyboard hotkeys
- L6161 - [sync] Manual save to cloud
- L6171 - [sync] Auto-save
- L6178 - [sync] Local backup (IndexedDB takeoff state)
- L6311 - [sync] Checkout keep-alive
- L6325 - App feature registry
- L6598 - View-only mode
- L6604 - Init / boot
