...
- L343 - State
- L584 - [sync] Sync recovery & client recycle
- L1006 - [sync] Global force reload
- L1129 - [sync] Save Status log & envelope
- L1274 - [sync] Dirty tracking & local session reset
- L1489 - [sync] Checkout probe, hashing & PDF cache
- L1736 - Math & Format Helpers
- L2512 - Coordinate Helpers
- L2524 - PDF Rendering
- L3836 - UI Render Functions
- L4959 - Inline rename & polyline edit mode
- L5073 - Item detail & properties modals
- L5411 - Toasts & line color picker
- L5559 - Airboard cloud sync
- L5592 - Supabase RPC & presence heartbeat
- L5632 - User activity / event telemetry
- L5675 - Supabase auth & dev auth
- L5796 - [sync] Checkout subscription & permission refresh
- L5974 - Modals & Handlers
- L6047 - PDF intake (upload, test PDF, hashing)
- L6372 - Toolbar tool buttons
- L6480 - Tool sidebar buttons & legend overlay
- L6594 - Add Line Type modal
- L6664 - Line color & sidebar handlers
- L6808 - Polyline modal & drawing
- L6839 - Zoom bar & page navigation
- L6879 - Canvas layers
- L7082 - PDF download helpers & PipeTooling menu
- L7158 - Copy summaries (PipeTooling / Email)
- L7360 - Import-canvas-after-PDF & Clear Page modals
- L7536 - Download current page
- L7784 - Zone & page-action modal handlers
- L7888 - Mobile actions burger menu (right-side drawer)
- L8016 - User activity time formatting
- L8174 - User Activity modal (admin)
- L8242 - My Settings modal
- L8273 - Auth & settings entry buttons
  - L8318 - Project Settings checkout & Save Status bell
  - L8436 - [sync] Checkout expired recovery
  - L8690 - [sync] Turn In
  - L9203 - Share project & view links
  - L9423 - Cloud project hydrate / copy / fork
  - L9619 - Settings menu actions & Airboard sync
  - L9698 - My Settings password & Auth sign-in
  - L9751 - Save Project modal
  - L9954 - Copy project modal
  - L9978 - Checkout expired recovery modal wiring
  - L10062 - Save-before-load modal
  - L10137 - Last-session restore prompt
  - L10216 - User Activity filters & view toggle
- L10404 - Canvas Event Handlers
- L10776 - Event Binding
- L10779 - Aim loupe (mobile press-hold precise placement)
- L11791 - [sync] Manual save to cloud
- L12416 - [sync] Auto-save
- L12713 - [sync] Local backup (IndexedDB takeoff state)
- L12939 - [sync] Checkout keep-alive
- L12983 - App feature registry
- L13113 - View-only mode
- L13268 - Init / boot
