...
|------|------:|------------------|
| [app.js](app.js) | 6,701 | **The remaining monolith** — down from 16.2k (9.9k after save-engine Stage 6, 8.1k after the Tier-2 splits, then −987 from the canvas-draw extraction). The only file worth actively shrinking; the region table below says what's left and in what order. |
...
| [styles.css](styles.css) | 1,432 | All CSS, token-organized. Leave. |
...
| `features/*.js` (55 files) | 12,579 total | Healthy: largest after load-project are quick-modals (462), user-activity (459), user-admin (453), room-sizer (443), output (416), scale (412) — each single-feature scoped with its own Playwright spec. Leave. |
...
- L3553 - Polyline modal & drawing
- L3584 - Zoom bar & page navigation
- L3610 - Export canvas JSON
- L3626 - PDF download helpers
- L3635 - View-link URL helpers & show-highlights/notes
- L3707 - Custom icon upload handler
- L3717 - Export & report dropdown menus
- L3804 - Sidebar drawer toggles
- L3815 - Mobile actions burger menu pointer & header logo
- L3827 - User Activity pointer (format.js + features/user-activity.js)
- L3839 - My Settings pointer (features/my-settings.js)
- L3862 - Auth & settings entry buttons
  - L3907 - Project Settings checkout & Save Status bell
  - L4008 - [sync] Checkout expired recovery
  - L4064 - [sync] Turn In
  - L4166 - Share modal pointer & copy-project openers
  - L4197 - Settings menu actions
  - L4218 - Auth sign-in form
  - L4242 - Save Project modal
  - L4255 - Checkout expired recovery modal wiring
  - L4360 - Last-session restore prompt
  - L4367 - Canvas Repair modal wiring
- L4520 - Canvas Event Handlers
- L4914 - Event Binding
- L4924 - Aim loupe (mobile press-hold precise placement)
- L5063 - Zoom transform preview & commit
- L5142 - Canvas mouse, wheel & touch handlers
- L5803 - Global dropdown dismissal & keyboard hotkeys
- L6065 - [sync] Manual save to cloud
- L6075 - [sync] Auto-save
- L6082 - [sync] Local backup (IndexedDB takeoff state)
- L6215 - [sync] Checkout keep-alive
- L6229 - App feature registry
- L6490 - View-only mode
- L6496 - Init / boot
...
- **Sidebar usage filter (off / page / project)** — the inline button next to
  ...
  and each cycle click fires a three-line toast — "Filter:" / landed state /
  dimmed next-click hint — via `showFilterScopeToast`);
