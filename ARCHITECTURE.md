...
| [styles.css](styles.css) | 1,783 | All CSS, token-organized. Leave. |
...
| `features/*.js` (69 files) | 16,549 total | Healthy: largest after load-project are quick-modals (462), user-activity (459), user-admin (453), room-sizer (443), output (416), scale (412) — each single-feature scoped with its own Playwright spec. Leave. |
