...
- L1967 - PDF Rendering
- L3407 - UI Render Functions
- L4554 - Inline rename & polyline edit mode
- L4668 - Modal primitives (showModal / hideModal)
- L4687 - Toasts & line color picker
- L4835 - Airboard cloud sync
- L4868 - Supabase RPC & presence heartbeat
- L4908 - User activity / event telemetry
- L4951 - Supabase auth & dev auth
- L5080 - [sync] Checkout subscription & permission refresh
- L5090 - Modals & Handlers
- L5163 - PDF intake (upload, test PDF, hashing)
- L5491 - Toolbar tool buttons
- L5599 - Tool sidebar buttons & legend overlay
- L5713 - Add Line Type modal
- L5783 - Line color & sidebar handlers
- L5927 - Polyline modal & drawing
- L5958 - Zoom bar & page navigation
- L5984 - Export canvas JSON
- L6000 - PDF download helpers
- L6053 - View-link URL helpers & show-highlights/notes
- L6125 - Custom icon upload handler
- L6250 - Export & report dropdown menus
- L6340 - Sidebar drawer toggles
- L6351 - Mobile actions burger menu pointer & header logo
- L6363 - User Activity pointer (format.js + features/user-activity.js)
- L6375 - My Settings pointer (features/my-settings.js)
- L6398 - Auth & settings entry buttons
  - L6443 - Project Settings checkout & Save Status bell
  - L6544 - [sync] Checkout expired recovery
  - L6600 - [sync] Turn In
  - L6879 - Share modal pointer & copy-project openers
  - L6922 - Cloud project hydrate / copy / fork
  - L7119 - Settings menu actions
  - L7140 - Auth sign-in form
  - L7164 - Save Project modal
  - L7367 - Copy project modal
  - L7391 - Checkout expired recovery modal wiring
  - L7475 - Save-before-load modal
  - L7550 - Last-session restore prompt
  - L7629 - Canvas Repair modal wiring
- L7776 - Canvas Event Handlers
- L8148 - Event Binding
- L8158 - Aim loupe (mobile press-hold precise placement)
- L8296 - Zoom transform preview & commit
- L8332 - Canvas mouse, wheel & touch handlers
- L8953 - Global dropdown dismissal & keyboard hotkeys
- L9181 - [sync] Manual save to cloud
- L9191 - [sync] Auto-save
- L9198 - [sync] Local backup (IndexedDB takeoff state)
- L9331 - [sync] Checkout keep-alive
- L9345 - App feature registry
- L9519 - View-only mode
- L9800 - Init / boot
