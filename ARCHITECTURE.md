...
|------|------:|------------------|
| [app.js](app.js) | 6,551 | **The remaining monolith** — down from 16.2k (9.9k after save-engine Stage 6, 8.1k after the Tier-2 splits, then −987 from the canvas-draw extraction). The only file worth actively shrinking; the region table below says what's left and in what order. |
...
| `features/*.js` (55 files) | 12,349 total | Healthy: largest after load-project are quick-modals (462), user-activity (459), user-admin (453), room-sizer (443), output (416), scale (412) — each single-feature scoped with its own Playwright spec. Leave. |
...
- L1168 - Coordinate Helpers
- L1176 - PDF render bitmap cache
- L1230 - Sharp crop tile (deep-zoom sharpening + window-first commits)
- L1241 - PDF Rendering
- L1924 - UI Render Functions
- L2470 - Inline rename & polyline edit mode
- L2584 - Modal primitives (showModal / hideModal)
- L2614 - Toasts & line color picker
- L2668 - Airboard cloud sync
- L2710 - Supabase RPC & presence heartbeat
- L2750 - User activity / event telemetry
- L2793 - Supabase auth & dev auth
- L2925 - [sync] Checkout subscription & permission refresh
- L2935 - Modals & Handlers
- L3003 - PDF intake (upload, test PDF, hashing)
- L3011 - Toolbar tool buttons
- L3124 - Tool sidebar buttons & legend overlay
- L3214 - Add Line Type modal
- L3284 - Line color & sidebar handlers
- L3426 - Polyline modal & drawing
- L3457 - Zoom bar & page navigation
- L3483 - Export canvas JSON
- L3499 - PDF download helpers
- L3508 - View-link URL helpers & show-highlights/notes
- L3580 - Custom icon upload handler
- L3590 - Export & report dropdown menus
- L3677 - Sidebar drawer toggles
- L3688 - Mobile actions burger menu pointer & header logo
- L3700 - User Activity pointer (format.js + features/user-activity.js)
- L3712 - My Settings pointer (features/my-settings.js)
- L3735 - Auth & settings entry buttons
  - L3780 - Project Settings checkout & Save Status bell
  - L3881 - [sync] Checkout expired recovery
  - L3937 - [sync] Turn In
  - L4039 - Share modal pointer & copy-project openers
  - L4070 - Settings menu actions
  - L4091 - Auth sign-in form
  - L4115 - Save Project modal
  - L4128 - Checkout expired recovery modal wiring
  - L4233 - Last-session restore prompt
  - L4240 - Canvas Repair modal wiring
- L4393 - Canvas Event Handlers
- L4787 - Event Binding
- L4797 - Aim loupe (mobile press-hold precise placement)
- L4936 - Zoom transform preview & commit
- L5015 - Canvas mouse, wheel & touch handlers
- L5676 - Global dropdown dismissal & keyboard hotkeys
- L5938 - [sync] Manual save to cloud
- L5948 - [sync] Auto-save
- L5955 - [sync] Local backup (IndexedDB takeoff state)
- L6088 - [sync] Checkout keep-alive
- L6102 - App feature registry
- L6346 - View-only mode
- L6352 - Init / boot
