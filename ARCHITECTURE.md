...
- L378 - State
- L526 - [sync] Sync recovery & client recycle
- L577 - [sync] Global force reload
- L660 - [sync] Save Status log & envelope
- L673 - [sync] Dirty tracking & local session reset
- L679 - Undo/redo stacks
- L846 - [sync] Checkout probe, hashing & PDF cache
- L1008 - Math & Format Helpers
- L1797 - Coordinate Helpers
- L1805 - PDF render bitmap cache
- L1972 - PDF Rendering
- L3426 - UI Render Functions
- L4573 - Inline rename & polyline edit mode
- L4687 - Modal primitives (showModal / hideModal)
- L4706 - Toasts & line color picker
- L4854 - Airboard cloud sync
- L4887 - Supabase RPC & presence heartbeat
- L4927 - User activity / event telemetry
- L4970 - Supabase auth & dev auth
- L5099 - [sync] Checkout subscription & permission refresh
- L5109 - Modals & Handlers
- L5182 - PDF intake (upload, test PDF, hashing)
- L5510 - Toolbar tool buttons
- L5618 - Tool sidebar buttons & legend overlay
- L5732 - Add Line Type modal
- L5802 - Line color & sidebar handlers
- L5946 - Polyline modal & drawing
- L5977 - Zoom bar & page navigation
- L6003 - Export canvas JSON
- L6019 - PDF download helpers
- L6072 - View-link URL helpers & show-highlights/notes
- L6144 - Custom icon upload handler
- L6269 - Export & report dropdown menus
- L6359 - Sidebar drawer toggles
- L6370 - Mobile actions burger menu pointer & header logo
- L6382 - User Activity pointer (format.js + features/user-activity.js)
- L6394 - My Settings pointer (features/my-settings.js)
- L6417 - Auth & settings entry buttons
  - L6462 - Project Settings checkout & Save Status bell
  - L6563 - [sync] Checkout expired recovery
  - L6619 - [sync] Turn In
  - L6898 - Share modal pointer & copy-project openers
  - L6929 - Settings menu actions
  - L6950 - Auth sign-in form
  - L6974 - Save Project modal
  - L6987 - Checkout expired recovery modal wiring
  - L7092 - Last-session restore prompt
  - L7171 - Canvas Repair modal wiring
- L7318 - Canvas Event Handlers
- L7690 - Event Binding
- L7700 - Aim loupe (mobile press-hold precise placement)
- L7838 - Zoom transform preview & commit
- L7874 - Canvas mouse, wheel & touch handlers
- L8495 - Global dropdown dismissal & keyboard hotkeys
- L8723 - [sync] Manual save to cloud
- L8733 - [sync] Auto-save
- L8740 - [sync] Local backup (IndexedDB takeoff state)
- L8873 - [sync] Checkout keep-alive
- L8887 - App feature registry
- L9071 - View-only mode
- L9077 - Init / boot
