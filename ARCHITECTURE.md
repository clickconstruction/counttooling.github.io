...
|------|------:|------------------|
| [app.js](app.js) | 6,684 | **The remaining monolith** — down from 16.2k (9.9k after save-engine Stage 6, 8.1k after the Tier-2 splits, then −987 from the canvas-draw extraction). The only file worth actively shrinking; the region table below says what's left and in what order. |
...
| [app/index.html](app/index.html) | 2,419 | The shell: HTML structure + every modal, no inline JS. Flat markup with no build step to split it; grows roughly linearly with modal count. Leave. |
...
| `features/*.js` (49 files) | 11,153 total | Healthy: largest after load-project are quick-modals (462), user-activity (459), user-admin (453), room-sizer (443), output (416), scale (412) — each single-feature scoped with its own Playwright spec. Leave. |
...
- L3752 - Auth & settings entry buttons
  ...
  - L3954 - [sync] Turn In
  - L4219 - Share modal pointer & copy-project openers
  - L4250 - Settings menu actions
  - L4271 - Auth sign-in form
  - L4295 - Save Project modal
  - L4308 - Checkout expired recovery modal wiring
  - L4413 - Last-session restore prompt
  - L4420 - Canvas Repair modal wiring
- L4573 - Canvas Event Handlers
- L4963 - Event Binding
- L4973 - Aim loupe (mobile press-hold precise placement)
- L5112 - Zoom transform preview & commit
- L5191 - Canvas mouse, wheel & touch handlers
- L5852 - Global dropdown dismissal & keyboard hotkeys
- L6112 - [sync] Manual save to cloud
- L6122 - [sync] Auto-save
- L6129 - [sync] Local backup (IndexedDB takeoff state)
- L6262 - [sync] Checkout keep-alive
- L6276 - App feature registry
