...
- L1159 - [sync] Dirty tracking & local session reset
- L1374 - [sync] Checkout probe, hashing & PDF cache
- L1621 - Math & Format Helpers
- L2302 - Coordinate Helpers
- L2314 - PDF Rendering
- L3486 - UI Render Functions
- L4597 - Inline rename & polyline edit mode
- L4711 - Item detail & properties modals
- L5035 - Toasts & line color picker
- L5121 - Airboard cloud sync
- L5154 - Supabase RPC & presence heartbeat
- L5194 - User activity / event telemetry
- L5237 - Supabase auth & dev auth
- L5358 - [sync] Checkout subscription & permission refresh
- L5526 - Modals & Handlers
- L5599 - PDF intake (upload, test PDF, hashing)
- L5924 - Toolbar tool buttons
- L6031 - Tool sidebar buttons & legend overlay
- L6145 - Add Line Type modal
- L6217 - Line color & sidebar handlers
- L6361 - Polyline modal & drawing
- L6392 - Zoom bar & page navigation
- L6431 - Canvas layers
- L6634 - PDF download helpers & PipeTooling menu
- L6709 - Copy summaries (PipeTooling / Email)
- L6844 - Import-canvas-after-PDF & Clear Page modals
- L7020 - Download current page
- L7268 - Zone & page-action modal handlers
- L7378 - User activity time formatting
- L7536 - User Activity modal (admin)
- L7604 - My Settings modal
- L7635 - Auth & settings entry buttons
  - L7678 - Project Settings checkout & Save Status bell
  - L7808 - [sync] Checkout expired recovery
  - L8062 - [sync] Turn In
  - L8564 - Share project & view links
  - L8784 - Cloud project hydrate / copy / fork
  - L8980 - Settings menu actions & Airboard sync
  - L9059 - My Settings password & Auth sign-in
  - L9112 - Save Project modal
  - L9315 - Copy project modal
  - L9339 - Checkout expired recovery modal wiring
  - L9423 - Save-before-load modal
  - L9498 - Last-session restore prompt
  - L9526 - User Activity filters & view toggle
- L9714 - Canvas Event Handlers
- L10058 - Event Binding
- L10811 - [sync] Manual save to cloud
- L11260 - [sync] Auto-save
- L11557 - [sync] Local backup (IndexedDB takeoff state)
- L11774 - [sync] Checkout keep-alive
- L11818 - App feature registry
- L11941 - View-only mode
- L12094 - Init / boot
