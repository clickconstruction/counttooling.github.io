...
- L6791 - Import-canvas-after-PDF & Clear Page modals
- L6967 - Download current page
- L7215 - Zone & page-action modal handlers
- L7325 - User activity time formatting
- L7483 - User Activity modal (admin)
- L7551 - My Settings modal
- L7582 - Auth & settings entry buttons
  - L7625 - Project Settings checkout & Save Status bell
  - L7755 - Checkout expired recovery
  - L8009 - Turn In
  - L8511 - Share project & view links
  - L8731 - Cloud project hydrate / copy / fork
  ...
  - L9473 - User Activity filters & view toggle
- L9661 - Canvas Event Handlers
- L10005 - Event Binding
- L10758 - Manual save to cloud
- L11207 - Auto-save
- L11504 - Local backup (IndexedDB takeoff state)
- L11719 - Checkout keep-alive
- L11763 - App feature registry
- L11886 - View-only mode
- L12039 - Init / boot
