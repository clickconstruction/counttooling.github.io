...
- L2549 - Coordinate Helpers
- L2561 - PDF Rendering
- L3873 - UI Render Functions
- L4996 - Inline rename & polyline edit mode
- L5110 - Item detail & properties modals
- L5448 - Toasts & line color picker
- L5596 - Airboard cloud sync
- L5629 - Supabase RPC & presence heartbeat
- L5669 - User activity / event telemetry
- L5712 - Supabase auth & dev auth
- L5833 - [sync] Checkout subscription & permission refresh
- L6011 - Modals & Handlers
- L6084 - PDF intake (upload, test PDF, hashing)
- L6409 - Toolbar tool buttons
- L6517 - Tool sidebar buttons & legend overlay
- L6631 - Add Line Type modal
- L6701 - Line color & sidebar handlers
- L6845 - Polyline modal & drawing
- L6876 - Zoom bar & page navigation
- L6916 - Canvas layers
- L7119 - PDF download helpers & PipeTooling menu
- L7195 - Copy summaries (PipeTooling / Email)
- L7397 - Import-canvas-after-PDF & Clear Page modals
- L7573 - Download current page
- L7821 - Zone & page-action modal handlers
- L7925 - Mobile actions burger menu (right-side drawer)
- L8053 - User activity time formatting
- L8211 - User Activity modal (admin)
- L8279 - My Settings modal
- L8310 - Auth & settings entry buttons
  - L8355 - Project Settings checkout & Save Status bell
  - L8478 - [sync] Checkout expired recovery
  - L8732 - [sync] Turn In
  - L9245 - Share project & view links
  - L9465 - Cloud project hydrate / copy / fork
  - L9661 - Settings menu actions & Airboard sync
  - L9740 - My Settings password & Auth sign-in
  - L9793 - Save Project modal
  - L9996 - Copy project modal
  - L10020 - Checkout expired recovery modal wiring
  - L10104 - Save-before-load modal
  - L10179 - Last-session restore prompt
  - L10258 - User Activity filters & view toggle
- L10446 - Canvas Event Handlers
- L10818 - Event Binding
- L10821 - Aim loupe (mobile press-hold precise placement)
- L11833 - [sync] Manual save to cloud
- L12458 - [sync] Auto-save
- L12755 - [sync] Local backup (IndexedDB takeoff state)
- L12982 - [sync] Checkout keep-alive
- L13026 - App feature registry
- L13156 - View-only mode
- L13325 - Init / boot
