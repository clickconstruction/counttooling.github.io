...
- L143 - State
- L291 - [sync] Sync recovery & client recycle
- L342 - [sync] Global force reload
- L425 - [sync] Save Status log & envelope
- L438 - [sync] Dirty tracking & local session reset
- L444 - Undo/redo stacks
- L552 - [sync] Checkout probe, hashing & PDF cache
- L714 - Math & Format Helpers
- L1503 - Coordinate Helpers
- L1511 - PDF render bitmap cache
- L1678 - PDF Rendering
- L3132 - UI Render Functions
- L4279 - Inline rename & polyline edit mode
- L4393 - Modal primitives (showModal / hideModal)
- L4412 - Toasts & line color picker
- L4466 - Airboard cloud sync
- L4499 - Supabase RPC & presence heartbeat
- L4539 - User activity / event telemetry
- L4582 - Supabase auth & dev auth
- L4711 - [sync] Checkout subscription & permission refresh
- L4721 - Modals & Handlers
- L4794 - PDF intake (upload, test PDF, hashing)
- L5122 - Toolbar tool buttons
- L5230 - Tool sidebar buttons & legend overlay
- L5344 - Add Line Type modal
- L5414 - Line color & sidebar handlers
- L5556 - Polyline modal & drawing
- L5587 - Zoom bar & page navigation
- L5613 - Export canvas JSON
- L5629 - PDF download helpers
- L5638 - View-link URL helpers & show-highlights/notes
- L5710 - Custom icon upload handler
- L5720 - Export & report dropdown menus
- L5810 - Sidebar drawer toggles
- L5821 - Mobile actions burger menu pointer & header logo
- L5833 - User Activity pointer (format.js + features/user-activity.js)
- L5845 - My Settings pointer (features/my-settings.js)
- L5868 - Auth & settings entry buttons
  - L5913 - Project Settings checkout & Save Status bell
  - L6014 - [sync] Checkout expired recovery
  - L6070 - [sync] Turn In
  - L6349 - Share modal pointer & copy-project openers
  - L6380 - Settings menu actions
  - L6401 - Auth sign-in form
  - L6425 - Save Project modal
  - L6438 - Checkout expired recovery modal wiring
  - L6543 - Last-session restore prompt
  - L6622 - Canvas Repair modal wiring
- L6767 - Canvas Event Handlers
- L7139 - Event Binding
- L7149 - Aim loupe (mobile press-hold precise placement)
- L7287 - Zoom transform preview & commit
- L7323 - Canvas mouse, wheel & touch handlers
- L7944 - Global dropdown dismissal & keyboard hotkeys
- L8172 - [sync] Manual save to cloud
- L8182 - [sync] Auto-save
- L8189 - [sync] Local backup (IndexedDB takeoff state)
- L8322 - [sync] Checkout keep-alive
- L8336 - App feature registry
- L8517 - View-only mode
- L8523 - Init / boot
