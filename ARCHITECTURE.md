...
- L702 - [sync] Checkout probe, hashing & PDF cache
- L764 - Math & Format Helpers
- L1177 - Coordinate Helpers
- L1185 - PDF render bitmap cache
- L1239 - Sharp crop tile (deep-zoom sharpening + window-first commits)
- L1250 - PDF Rendering
- L1957 - UI Render Functions
- L2503 - Inline rename & polyline edit mode
- L2617 - Modal primitives (showModal / hideModal)
- L2647 - Toasts & line color picker
- L2701 - Airboard cloud sync
- L2746 - Supabase RPC & presence heartbeat
- L2786 - User activity / event telemetry
- L2829 - Supabase auth & dev auth
- L2961 - [sync] Checkout subscription & permission refresh
- L2971 - Modals & Handlers
- L3039 - PDF intake (upload, test PDF, hashing)
- L3047 - Toolbar tool buttons
- L3160 - Tool sidebar buttons & legend overlay
- L3250 - Add Line Type modal
- L3320 - Line color & sidebar handlers
- L3498 - Polyline modal & drawing
- L3529 - Zoom bar & page navigation
- L3555 - Export canvas JSON
- L3571 - PDF download helpers
- L3580 - View-link URL helpers & show-highlights/notes
- L3652 - Custom icon upload handler
- L3662 - Export & report dropdown menus
- L3749 - Sidebar drawer toggles
- L3760 - Mobile actions burger menu pointer & header logo
- L3772 - User Activity pointer (format.js + features/user-activity.js)
- L3784 - My Settings pointer (features/my-settings.js)
- L3807 - Auth & settings entry buttons
  - L3852 - Project Settings checkout & Save Status bell
  - L3953 - [sync] Checkout expired recovery
  - L4009 - [sync] Turn In
  - L4111 - Share modal pointer & copy-project openers
  - L4142 - Settings menu actions
  - L4163 - Auth sign-in form
  - L4187 - Save Project modal
  - L4200 - Checkout expired recovery modal wiring
  - L4305 - Last-session restore prompt
  - L4312 - Canvas Repair modal wiring
- L4465 - Canvas Event Handlers
- L4859 - Event Binding
- L4869 - Aim loupe (mobile press-hold precise placement)
- L5008 - Zoom transform preview & commit
- L5087 - Canvas mouse, wheel & touch handlers
- L5748 - Global dropdown dismissal & keyboard hotkeys
- L6010 - [sync] Manual save to cloud
- L6020 - [sync] Auto-save
- L6027 - [sync] Local backup (IndexedDB takeoff state)
- L6160 - [sync] Checkout keep-alive
- L6174 - App feature registry
- L6432 - View-only mode
- L6438 - Init / boot
