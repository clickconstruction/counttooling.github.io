...
Current first-party line counts (`wc -l`, 2026-08-17 — the **numbers and this
...
|------|------:|------------------|
| [app.js](app.js) | 6,816 | **The remaining monolith** — down from 16.2k (9.9k after save-engine Stage 6, 8.1k after the Tier-2 splits, then −987 from the canvas-draw extraction). The only file worth actively shrinking; the region table below says what's left and in what order. |
...
- L2568 - Inline rename & polyline edit mode
- L2682 - Modal primitives (showModal / hideModal)
- L2712 - Toasts & line color picker
- L2766 - Airboard cloud sync
- L2811 - Supabase RPC & presence heartbeat
- L2851 - User activity / event telemetry
- L2894 - Supabase auth & dev auth
- L3026 - [sync] Checkout subscription & permission refresh
- L3036 - Modals & Handlers
- L3104 - PDF intake (upload, test PDF, hashing)
- L3112 - Toolbar tool buttons
- L3247 - Tool sidebar buttons & legend overlay
- L3338 - Add Line Type modal
- L3423 - Line color & sidebar handlers
- L3632 - Polyline modal & drawing
- L3663 - Zoom bar & page navigation
- L3689 - Export canvas JSON
- L3705 - PDF download helpers
- L3714 - View-link URL helpers & show-highlights/notes
- L3786 - Custom icon upload handler
- L3796 - Export & report dropdown menus
- L3883 - Sidebar drawer toggles
- L3894 - Mobile actions burger menu pointer & header logo
- L3906 - User Activity pointer (format.js + features/user-activity.js)
- L3918 - My Settings pointer (features/my-settings.js)
- L3941 - Auth & settings entry buttons
  - L3986 - Project Settings checkout & Save Status bell
  - L4087 - [sync] Checkout expired recovery
  - L4143 - [sync] Turn In
  - L4245 - Share modal pointer & copy-project openers
  - L4276 - Settings menu actions
  - L4297 - Auth sign-in form
  - L4321 - Save Project modal
  - L4334 - Checkout expired recovery modal wiring
  - L4439 - Last-session restore prompt
  - L4446 - Canvas Repair modal wiring
- L4599 - Canvas Event Handlers
- L4999 - Event Binding
- L5009 - Aim loupe (mobile press-hold precise placement)
- L5149 - Zoom transform preview & commit
- L5228 - Canvas mouse, wheel & touch handlers
- L5889 - Global dropdown dismissal & keyboard hotkeys
- L6168 - [sync] Manual save to cloud
- L6178 - [sync] Auto-save
- L6185 - [sync] Local backup (IndexedDB takeoff state)
- L6318 - [sync] Checkout keep-alive
- L6332 - App feature registry
- L6605 - View-only mode
- L6611 - Init / boot
