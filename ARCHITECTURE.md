...
|------|------:|------------------|
| [app.js](app.js) | 6,957 | **The remaining monolith** — down from 16.2k (9.9k after save-engine Stage 6, 8.1k after the Tier-2 splits, then −987 from the canvas-draw extraction). The only file worth actively shrinking; the region table below says what's left and in what order. |
...
- L2863 - Toasts & line color picker
- L2917 - Airboard cloud sync
- L2959 - Supabase RPC & presence heartbeat
- L2999 - User activity / event telemetry
- L3042 - Supabase auth & dev auth
- L3174 - [sync] Checkout subscription & permission refresh
- L3184 - Modals & Handlers
- L3252 - PDF intake (upload, test PDF, hashing)
- L3260 - Toolbar tool buttons
- L3386 - Tool sidebar buttons & legend overlay
- L3504 - Add Line Type modal
- L3574 - Line color & sidebar handlers
- L3716 - Polyline modal & drawing
- L3747 - Zoom bar & page navigation
- L3773 - Export canvas JSON
- L3789 - PDF download helpers
- L3798 - View-link URL helpers & show-highlights/notes
- L3870 - Custom icon upload handler
- L3880 - Export & report dropdown menus
- L3969 - Sidebar drawer toggles
- L3980 - Mobile actions burger menu pointer & header logo
- L3992 - User Activity pointer (format.js + features/user-activity.js)
- L4004 - My Settings pointer (features/my-settings.js)
- L4027 - Auth & settings entry buttons
  - L4072 - Project Settings checkout & Save Status bell
  - L4173 - [sync] Checkout expired recovery
  - L4229 - [sync] Turn In
  - L4494 - Share modal pointer & copy-project openers
  - L4525 - Settings menu actions
  - L4546 - Auth sign-in form
  - L4570 - Save Project modal
  - L4583 - Checkout expired recovery modal wiring
  - L4688 - Last-session restore prompt
  - L4695 - Canvas Repair modal wiring
- L4848 - Canvas Event Handlers
- L5238 - Event Binding
- L5248 - Aim loupe (mobile press-hold precise placement)
- L5387 - Zoom transform preview & commit
- L5466 - Canvas mouse, wheel & touch handlers
- L6127 - Global dropdown dismissal & keyboard hotkeys
- L6387 - [sync] Manual save to cloud
- L6397 - [sync] Auto-save
- L6404 - [sync] Local backup (IndexedDB takeoff state)
- L6537 - [sync] Checkout keep-alive
- L6551 - App feature registry
- L6780 - View-only mode
- L6786 - Init / boot
