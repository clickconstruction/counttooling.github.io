...
|------|------:|------------------|
| [app.js](app.js) | 7,792 | **The remaining monolith** — down from 16.2k (9.9k after save-engine Stage 6, 8.1k after the Tier-2 splits, then −987 from the canvas-draw extraction). The only file worth actively shrinking; the region table below says what's left and in what order. |
...
- L477 - [sync] Dirty tracking & local session reset
- L483 - Undo/redo stacks
- L612 - [sync] Checkout probe, hashing & PDF cache
- L674 - Math & Format Helpers
- L1307 - Coordinate Helpers
- L1315 - PDF render bitmap cache
- L1664 - Sharp crop tile (deep-zoom sharpening + window-first commits)
- L1959 - PDF Rendering
- L2606 - UI Render Functions
- L3600 - Inline rename & polyline edit mode
- L3714 - Modal primitives (showModal / hideModal)
- L3733 - Toasts & line color picker
- L3787 - Airboard cloud sync
- L3825 - Supabase RPC & presence heartbeat
- L3865 - User activity / event telemetry
- L3908 - Supabase auth & dev auth
- L4040 - [sync] Checkout subscription & permission refresh
- L4050 - Modals & Handlers
- L4118 - PDF intake (upload, test PDF, hashing)
- L4126 - Toolbar tool buttons
- L4252 - Tool sidebar buttons & legend overlay
- L4369 - Add Line Type modal
- L4439 - Line color & sidebar handlers
- L4581 - Polyline modal & drawing
- L4612 - Zoom bar & page navigation
- L4638 - Export canvas JSON
- L4654 - PDF download helpers
- L4663 - View-link URL helpers & show-highlights/notes
- L4735 - Custom icon upload handler
- L4745 - Export & report dropdown menus
- L4835 - Sidebar drawer toggles
- L4846 - Mobile actions burger menu pointer & header logo
- L4858 - User Activity pointer (format.js + features/user-activity.js)
- L4870 - My Settings pointer (features/my-settings.js)
- L4893 - Auth & settings entry buttons
  - L4938 - Project Settings checkout & Save Status bell
  - L5039 - [sync] Checkout expired recovery
  - L5095 - [sync] Turn In
  - L5360 - Share modal pointer & copy-project openers
  - L5391 - Settings menu actions
  - L5412 - Auth sign-in form
  - L5436 - Save Project modal
  - L5449 - Checkout expired recovery modal wiring
  - L5554 - Last-session restore prompt
  - L5561 - Canvas Repair modal wiring
- L5714 - Canvas Event Handlers
- L6104 - Event Binding
- L6114 - Aim loupe (mobile press-hold precise placement)
- L6253 - Zoom transform preview & commit
- L6332 - Canvas mouse, wheel & touch handlers
- L6993 - Global dropdown dismissal & keyboard hotkeys
- L7241 - [sync] Manual save to cloud
- L7251 - [sync] Auto-save
- L7258 - [sync] Local backup (IndexedDB takeoff state)
- L7391 - [sync] Checkout keep-alive
- L7405 - App feature registry
- L7615 - View-only mode
- L7621 - Init / boot
