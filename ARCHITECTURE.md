...
|------|------:|------------------|
| [app.js](app.js) | 7,241 | **The remaining monolith** — down from 16.2k (9.9k after save-engine Stage 6, 8.1k after the Tier-2 splits, then −987 from the canvas-draw extraction). The only file worth actively shrinking; the region table below says what's left and in what order. |
...
| [app/index.html](app/index.html) | 2,776 | The shell: HTML structure + every modal, no inline JS. Flat markup with no build step to split it; grows roughly linearly with modal count. Leave. |
| [styles.css](styles.css) | 1,709 | All CSS, token-organized. Leave. |
...
| `features/*.js` (68 files) | 15,715 total | Healthy: largest after load-project are quick-modals (462), user-activity (459), user-admin (453), room-sizer (443), output (416), scale (412) — each single-feature scoped with its own Playwright spec. Leave. |
...
- L2639 - Inline rename & polyline edit mode
- L2753 - Modal primitives (showModal / hideModal)
- L2784 - Toasts & line color picker
- L2851 - Airboard cloud sync
- L2896 - Supabase RPC & presence heartbeat
- L2936 - User activity / event telemetry
- L2995 - Supabase auth & dev auth
- L3139 - [sync] Checkout subscription & permission refresh
...
- L4131 - Auth & settings entry buttons
  - L4176 - Project Settings checkout & Save Status bell
  - L4268 - [sync] Checkout expired recovery
  - L4324 - [sync] Turn In
  - L4433 - Share modal pointer & copy-project openers
  - L4464 - Settings menu actions
  - L4485 - Auth sign-in form
  - L4510 - Save Project modal
  - L4523 - Checkout expired recovery modal wiring
  - L4628 - Last-session restore prompt
  - L4635 - Canvas Repair modal wiring
- L4822 - Canvas Event Handlers
- L5274 - Event Binding
- L5284 - Aim loupe (mobile press-hold precise placement)
- L5434 - Zoom transform preview & commit
- L5513 - Canvas mouse, wheel & touch handlers
- L6265 - Global dropdown dismissal & keyboard hotkeys
- L6558 - [sync] Manual save to cloud
- L6568 - [sync] Auto-save
- L6575 - [sync] Local backup (IndexedDB takeoff state)
- L6708 - [sync] Checkout keep-alive
- L6722 - App feature registry
- L7028 - View-only mode
- L7034 - Init / boot
