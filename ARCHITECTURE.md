...
- L8180 - Auth & settings entry buttons
  ...
  - L10123 - User Activity filters & view toggle
- L10311 - Canvas Event Handlers
- L10683 - Event Binding
- L10686 - Aim loupe (mobile press-hold precise placement)
- L11698 - [sync] Manual save to cloud
- L12323 - [sync] Auto-save
- L12620 - [sync] Local backup (IndexedDB takeoff state)
- L12846 - [sync] Checkout keep-alive
- L12890 - App feature registry
- L13019 - View-only mode
- L13174 - Init / boot
