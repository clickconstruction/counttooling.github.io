...
|------|------:|------------------|
| [app.js](app.js) | 7,290 | **The remaining monolith** — down from 16.2k (9.9k after save-engine Stage 6, 8.1k after the Tier-2 splits, then −987 from the canvas-draw extraction). The only file worth actively shrinking; the region table below says what's left and in what order. |
...
| `features/*.js` (68 files) | 15,752 total | Healthy: largest after load-project are quick-modals (462), user-activity (459), user-admin (453), room-sizer (443), output (416), scale (412) — each single-feature scoped with its own Playwright spec. Leave. |
...
- L6607 - [sync] Manual save to cloud
- L6617 - [sync] Auto-save
- L6624 - [sync] Local backup (IndexedDB takeoff state)
- L6757 - [sync] Checkout keep-alive
- L6771 - App feature registry
- L7077 - View-only mode
- L7083 - Init / boot
