...
- L5059 - Inline rename & polyline edit mode
- L5173 - Item detail & properties modals
- L5511 - Toasts & line color picker
- L5659 - Airboard cloud sync
- L5692 - Supabase RPC & presence heartbeat
- L5732 - User activity / event telemetry
- L5775 - Supabase auth & dev auth
- L5904 - [sync] Checkout subscription & permission refresh
- L6082 - Modals & Handlers
- L6155 - PDF intake (upload, test PDF, hashing)
- L6480 - Toolbar tool buttons
- L6588 - Tool sidebar buttons & legend overlay
- L6702 - Add Line Type modal
- L6772 - Line color & sidebar handlers
- L6916 - Polyline modal & drawing
- L6947 - Zoom bar & page navigation
- L6975 - Canvas layers
- L7178 - PDF download helpers & PipeTooling menu
- L7254 - Copy summaries (PipeTooling / Email)
- L7456 - Import-canvas-after-PDF & Clear Page modals
- L7632 - Download current page
- L7880 - Zone & page-action modal handlers
- L7984 - Mobile actions burger menu (right-side drawer)
- L8112 - User activity time formatting
- L8270 - User Activity modal (admin)
- L8338 - My Settings modal
- L8369 - Auth & settings entry buttons
  - L8414 - Project Settings checkout & Save Status bell
  - L8537 - [sync] Checkout expired recovery
  - L8791 - [sync] Turn In
  - L9304 - Share project & view links
  - L9524 - Cloud project hydrate / copy / fork
  - L9720 - Settings menu actions & Airboard sync
  - L9799 - My Settings password & Auth sign-in
  - L9852 - Save Project modal
  - L10055 - Copy project modal
  - L10079 - Checkout expired recovery modal wiring
  - L10163 - Save-before-load modal
  - L10238 - Last-session restore prompt
  - L10317 - User Activity filters & view toggle
- L10505 - Canvas Event Handlers
- L10877 - Event Binding
- L10880 - Aim loupe (mobile press-hold precise placement)
- L11894 - [sync] Manual save to cloud
- L12519 - [sync] Auto-save
- L12816 - [sync] Local backup (IndexedDB takeoff state)
- L13046 - [sync] Checkout keep-alive
- L13090 - App feature registry
- L13238 - View-only mode
- L13518 - Init / boot
