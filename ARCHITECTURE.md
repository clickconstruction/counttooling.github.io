...
- L1461 - [sync] Checkout probe, hashing & PDF cache
- L1708 - Math & Format Helpers
- L2389 - Coordinate Helpers
- L2401 - PDF Rendering
- L3605 - UI Render Functions
- L4727 - Inline rename & polyline edit mode
- L4841 - Item detail & properties modals
- L5165 - Toasts & line color picker
- L5313 - Airboard cloud sync
- L5346 - Supabase RPC & presence heartbeat
- L5386 - User activity / event telemetry
- L5429 - Supabase auth & dev auth
- L5550 - [sync] Checkout subscription & permission refresh
- L5728 - Modals & Handlers
- L5801 - PDF intake (upload, test PDF, hashing)
- L6126 - Toolbar tool buttons
- L6233 - Tool sidebar buttons & legend overlay
- L6347 - Add Line Type modal
- L6417 - Line color & sidebar handlers
- L6561 - Polyline modal & drawing
- L6592 - Zoom bar & page navigation
- L6631 - Canvas layers
- L6834 - PDF download helpers & PipeTooling menu
- L6910 - Copy summaries (PipeTooling / Email)
- L7112 - Import-canvas-after-PDF & Clear Page modals
- L7288 - Download current page
- L7536 - Zone & page-action modal handlers
- L7640 - Mobile actions burger menu (right-side drawer)
- L7768 - User activity time formatting
- L7926 - User Activity modal (admin)
- L7994 - My Settings modal
- L8025 - Auth & settings entry buttons
  - L8070 - Project Settings checkout & Save Status bell
  - L8188 - [sync] Checkout expired recovery
  - L8442 - [sync] Turn In
  - L8955 - Share project & view links
  - L9175 - Cloud project hydrate / copy / fork
  - L9371 - Settings menu actions & Airboard sync
  - L9450 - My Settings password & Auth sign-in
  - L9503 - Save Project modal
  - L9706 - Copy project modal
  - L9730 - Checkout expired recovery modal wiring
  - L9814 - Save-before-load modal
  - L9889 - Last-session restore prompt
  - L9917 - User Activity filters & view toggle
- L10105 - Canvas Event Handlers
- L10449 - Event Binding
- L11204 - [sync] Manual save to cloud
- L11829 - [sync] Auto-save
- L12126 - [sync] Local backup (IndexedDB takeoff state)
- L12352 - [sync] Checkout keep-alive
- L12396 - App feature registry
- L12522 - View-only mode
- L12677 - Init / boot
