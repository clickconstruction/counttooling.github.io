...
|------|------:|------------------|
| [app.js](app.js) | 7,194 | **The remaining monolith** — down from 16.2k (9.9k after save-engine Stage 6, 8.1k after the Tier-2 splits, then −987 from the canvas-draw extraction). The only file worth actively shrinking; the region table below says what's left and in what order. |
...
| [app/index.html](app/index.html) | 2,417 | The shell: HTML structure + every modal, no inline JS. Flat markup with no build step to split it; grows roughly linearly with modal count. Leave. |
...
| [annotation-model.js](annotation-model.js) | 482 | Done — extracted canvas/annotation data model + node tests. |
...
| `features/*.js` (47 files) | 10,932 total | Healthy: largest after load-project are quick-modals (462), user-activity (459), user-admin (453), room-sizer (443), output (416), scale (412) — each single-feature scoped with its own Playwright spec. Leave. |
...
- L173 - State
- L329 - [sync] Sync recovery & client recycle
- L410 - [sync] Global force reload
- L491 - [sync] Save Status log & envelope
- L494 - [sync] Field-error telemetry
- L553 - [sync] Dirty tracking & local session reset
- L559 - Undo/redo stacks
- L688 - [sync] Checkout probe, hashing & PDF cache
- L750 - Math & Format Helpers
- L1156 - Coordinate Helpers
- L1164 - PDF render bitmap cache
- L1213 - Sharp crop tile (deep-zoom sharpening + window-first commits)
- L1508 - PDF Rendering
- L2184 - UI Render Functions
- L2967 - Inline rename & polyline edit mode
- L3081 - Modal primitives (showModal / hideModal)
- L3100 - Toasts & line color picker
- L3154 - Airboard cloud sync
- L3196 - Supabase RPC & presence heartbeat
- L3236 - User activity / event telemetry
- L3279 - Supabase auth & dev auth
- L3411 - [sync] Checkout subscription & permission refresh
- L3421 - Modals & Handlers
- L3489 - PDF intake (upload, test PDF, hashing)
- L3497 - Toolbar tool buttons
- L3623 - Tool sidebar buttons & legend overlay
- L3741 - Add Line Type modal
- L3811 - Line color & sidebar handlers
- L3953 - Polyline modal & drawing
- L3984 - Zoom bar & page navigation
- L4010 - Export canvas JSON
- L4026 - PDF download helpers
- L4035 - View-link URL helpers & show-highlights/notes
- L4107 - Custom icon upload handler
- L4117 - Export & report dropdown menus
- L4206 - Sidebar drawer toggles
- L4217 - Mobile actions burger menu pointer & header logo
- L4229 - User Activity pointer (format.js + features/user-activity.js)
- L4241 - My Settings pointer (features/my-settings.js)
- L4264 - Auth & settings entry buttons
  - L4309 - Project Settings checkout & Save Status bell
  - L4410 - [sync] Checkout expired recovery
  - L4466 - [sync] Turn In
  - L4731 - Share modal pointer & copy-project openers
  - L4762 - Settings menu actions
  - L4783 - Auth sign-in form
  - L4807 - Save Project modal
  - L4820 - Checkout expired recovery modal wiring
  - L4925 - Last-session restore prompt
  - L4932 - Canvas Repair modal wiring
- L5085 - Canvas Event Handlers
- L5475 - Event Binding
- L5485 - Aim loupe (mobile press-hold precise placement)
- L5624 - Zoom transform preview & commit
- L5703 - Canvas mouse, wheel & touch handlers
- L6364 - Global dropdown dismissal & keyboard hotkeys
- L6624 - [sync] Manual save to cloud
- L6634 - [sync] Auto-save
- L6641 - [sync] Local backup (IndexedDB takeoff state)
- L6774 - [sync] Checkout keep-alive
- L6788 - App feature registry
- L7017 - View-only mode
- L7023 - Init / boot
