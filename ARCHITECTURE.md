...
- L970 - [sync] Global force reload
- L1090 - [sync] Save Status log & envelope
- L1234 - [sync] Dirty tracking & local session reset
- L1449 - [sync] Checkout probe, hashing & PDF cache
- L1696 - Math & Format Helpers
...
- L10896 - [sync] Manual save to cloud
- L11345 - [sync] Auto-save
- L11642 - [sync] Local backup (IndexedDB takeoff state)
- L11868 - [sync] Checkout keep-alive
- L11912 - App feature registry
- L12035 - View-only mode
- L12188 - Init / boot
