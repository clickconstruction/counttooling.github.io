...
- L2502 - Coordinate Helpers
- L2514 - PDF Rendering
- L3826 - UI Render Functions
- L4949 - Inline rename & polyline edit mode
- L5063 - Item detail & properties modals
- L5401 - Toasts & line color picker
- L5549 - Airboard cloud sync
- L5582 - Supabase RPC & presence heartbeat
- L5622 - User activity / event telemetry
- L5665 - Supabase auth & dev auth
- L5786 - [sync] Checkout subscription & permission refresh
- L5964 - Modals & Handlers
- L6037 - PDF intake (upload, test PDF, hashing)
- L6362 - Toolbar tool buttons
- L6470 - Tool sidebar buttons & legend overlay
- L6584 - Add Line Type modal
- L6654 - Line color & sidebar handlers
- L6798 - Polyline modal & drawing
- L6829 - Zoom bar & page navigation
- L6869 - Canvas layers
- L7072 - PDF download helpers & PipeTooling menu
- L7148 - Copy summaries (PipeTooling / Email)
- L7350 - Import-canvas-after-PDF & Clear Page modals
- L7526 - Download current page
- L7774 - Zone & page-action modal handlers
- L7878 - Mobile actions burger menu (right-side drawer)
- L8006 - User activity time formatting
- L8164 - User Activity modal (admin)
- L8232 - My Settings modal
- L8263 - Auth & settings entry buttons
  - L8308 - Project Settings checkout & Save Status bell
  - L8426 - [sync] Checkout expired recovery
  - L8680 - [sync] Turn In
  - L9193 - Share project & view links
  - L9413 - Cloud project hydrate / copy / fork
  - L9609 - Settings menu actions & Airboard sync
  - L9688 - My Settings password & Auth sign-in
  - L9741 - Save Project modal
  - L9944 - Copy project modal
  - L9968 - Checkout expired recovery modal wiring
  - L10052 - Save-before-load modal
  - L10127 - Last-session restore prompt
  - L10206 - User Activity filters & view toggle
- L10394 - Canvas Event Handlers
- L10766 - Event Binding
- L10769 - Aim loupe (mobile press-hold precise placement)
- L11781 - [sync] Manual save to cloud
- L12406 - [sync] Auto-save
- L12703 - [sync] Local backup (IndexedDB takeoff state)
- L12929 - [sync] Checkout keep-alive
- L12973 - App feature registry
- L13103 - View-only mode
- L13258 - Init / boot
