...
- L343 - State
- L583 - [sync] Sync recovery & client recycle
- L982 - [sync] Global force reload
- L1105 - [sync] Save Status log & envelope
- L1249 - [sync] Dirty tracking & local session reset
- L1464 - [sync] Checkout probe, hashing & PDF cache
- L1711 - Math & Format Helpers
- L2448 - Coordinate Helpers
- L2460 - PDF Rendering
- L3707 - UI Render Functions
- L4830 - Inline rename & polyline edit mode
- L4944 - Item detail & properties modals
- L5282 - Toasts & line color picker
- L5430 - Airboard cloud sync
- L5463 - Supabase RPC & presence heartbeat
- L5503 - User activity / event telemetry
- L5546 - Supabase auth & dev auth
- L5667 - [sync] Checkout subscription & permission refresh
- L5845 - Modals & Handlers
- L5918 - PDF intake (upload, test PDF, hashing)
- L6243 - Toolbar tool buttons
- L6351 - Tool sidebar buttons & legend overlay
- L6465 - Add Line Type modal
- L6535 - Line color & sidebar handlers
- L6679 - Polyline modal & drawing
- L6710 - Zoom bar & page navigation
- L6750 - Canvas layers
- L6953 - PDF download helpers & PipeTooling menu
- L7029 - Copy summaries (PipeTooling / Email)
- L7231 - Import-canvas-after-PDF & Clear Page modals
- L7407 - Download current page
- L7655 - Zone & page-action modal handlers
- L7759 - Mobile actions burger menu (right-side drawer)
- L7887 - User activity time formatting
- L8045 - User Activity modal (admin)
- L8113 - My Settings modal
- L8144 - Auth & settings entry buttons
  - L8189 - Project Settings checkout & Save Status bell
  - L8307 - [sync] Checkout expired recovery
  - L8561 - [sync] Turn In
  - L9074 - Share project & view links
  - L9294 - Cloud project hydrate / copy / fork
  - L9490 - Settings menu actions & Airboard sync
  - L9569 - My Settings password & Auth sign-in
  - L9622 - Save Project modal
  - L9825 - Copy project modal
  - L9849 - Checkout expired recovery modal wiring
  - L9933 - Save-before-load modal
  - L10008 - Last-session restore prompt
  - L10036 - User Activity filters & view toggle
- L10224 - Canvas Event Handlers
- L10596 - Event Binding
- L10599 - Aim loupe (mobile press-hold precise placement)
- L11601 - [sync] Manual save to cloud
- L12226 - [sync] Auto-save
- L12523 - [sync] Local backup (IndexedDB takeoff state)
- L12749 - [sync] Checkout keep-alive
- L12793 - App feature registry
- L12922 - View-only mode
- L13077 - Init / boot
