...
Current first-party line counts (`wc -l`, 2026-08-09 — the **numbers and this
...
|------|------:|------------------|
| [app.js](app.js) | 6,516 | **The remaining monolith** — down from 16.2k (9.9k after save-engine Stage 6, 8.1k after the Tier-2 splits, then −987 from the canvas-draw extraction). The only file worth actively shrinking; the region table below says what's left and in what order. |
...
| [report.js](report.js) | 477 | Self-contained report builder with a frozen `window.*` contract. Leave. |
...
- L2468 - Inline rename & polyline edit mode
- L2582 - Modal primitives (showModal / hideModal)
- L2612 - Toasts & line color picker
- L2666 - Airboard cloud sync
- L2708 - Supabase RPC & presence heartbeat
- L2748 - User activity / event telemetry
- L2791 - Supabase auth & dev auth
- L2923 - [sync] Checkout subscription & permission refresh
- L2933 - Modals & Handlers
- L3001 - PDF intake (upload, test PDF, hashing)
- L3009 - Toolbar tool buttons
- L3122 - Tool sidebar buttons & legend overlay
- L3212 - Add Line Type modal
- L3282 - Line color & sidebar handlers
- L3424 - Polyline modal & drawing
- L3455 - Zoom bar & page navigation
- L3481 - Export canvas JSON
- L3497 - PDF download helpers
- L3506 - View-link URL helpers & show-highlights/notes
- L3578 - Custom icon upload handler
- L3588 - Export & report dropdown menus
- L3675 - Sidebar drawer toggles
- L3686 - Mobile actions burger menu pointer & header logo
- L3698 - User Activity pointer (format.js + features/user-activity.js)
- L3710 - My Settings pointer (features/my-settings.js)
- L3733 - Auth & settings entry buttons
  - L3778 - Project Settings checkout & Save Status bell
  - L3879 - [sync] Checkout expired recovery
  - L3935 - [sync] Turn In
  - L4037 - Share modal pointer & copy-project openers
  - L4068 - Settings menu actions
  - L4089 - Auth sign-in form
  - L4113 - Save Project modal
  - L4126 - Checkout expired recovery modal wiring
  - L4231 - Last-session restore prompt
  - L4238 - Canvas Repair modal wiring
- L4391 - Canvas Event Handlers
- L4785 - Event Binding
- L4795 - Aim loupe (mobile press-hold precise placement)
- L4934 - Zoom transform preview & commit
- L5013 - Canvas mouse, wheel & touch handlers
- L5674 - Global dropdown dismissal & keyboard hotkeys
- L5936 - [sync] Manual save to cloud
- L5946 - [sync] Auto-save
- L5953 - [sync] Local backup (IndexedDB takeoff state)
- L6086 - [sync] Checkout keep-alive
- L6100 - App feature registry
- L6339 - View-only mode
- L6345 - Init / boot
