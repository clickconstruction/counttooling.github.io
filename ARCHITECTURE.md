...
|------|------:|------------------|
| [app.js](app.js) | 7,130 | **The remaining monolith** — down from 16.2k (9.9k after save-engine Stage 6, 8.1k after the Tier-2 splits, then −987 from the canvas-draw extraction). The only file worth actively shrinking; the region table below says what's left and in what order. |
...
| [app/index.html](app/index.html) | 2,766 | The shell: HTML structure + every modal, no inline JS. Flat markup with no build step to split it; grows roughly linearly with modal count. Leave. |
...
- L4015 - Sidebar drawer toggles
- L4026 - Mobile actions burger menu pointer & header logo
- L4038 - User Activity pointer (format.js + features/user-activity.js)
- L4050 - My Settings pointer (features/my-settings.js)
- L4073 - Auth & settings entry buttons
  - L4118 - Project Settings checkout & Save Status bell
  - L4210 - [sync] Checkout expired recovery
  - L4266 - [sync] Turn In
  - L4376 - Share modal pointer & copy-project openers
  - L4407 - Settings menu actions
  - L4428 - Auth sign-in form
  - L4453 - Save Project modal
  - L4466 - Checkout expired recovery modal wiring
  - L4571 - Last-session restore prompt
  - L4578 - Canvas Repair modal wiring
- L4765 - Canvas Event Handlers
- L5211 - Event Binding
- L5221 - Aim loupe (mobile press-hold precise placement)
- L5362 - Zoom transform preview & commit
- L5441 - Canvas mouse, wheel & touch handlers
- L6149 - Global dropdown dismissal & keyboard hotkeys
- L6459 - [sync] Manual save to cloud
- L6469 - [sync] Auto-save
- L6476 - [sync] Local backup (IndexedDB takeoff state)
- L6609 - [sync] Checkout keep-alive
- L6623 - App feature registry
- L6917 - View-only mode
- L6923 - Init / boot
