...
- L4829 - Inline rename & polyline edit mode
- L4943 - Item detail & properties modals
- L5267 - Toasts & line color picker
- L5415 - Airboard cloud sync
- L5448 - Supabase RPC & presence heartbeat
- L5488 - User activity / event telemetry
- L5531 - Supabase auth & dev auth
- L5652 - [sync] Checkout subscription & permission refresh
- L5830 - Modals & Handlers
- L5903 - PDF intake (upload, test PDF, hashing)
- L6228 - Toolbar tool buttons
- L6336 - Tool sidebar buttons & legend overlay
- L6450 - Add Line Type modal
- L6520 - Line color & sidebar handlers
- L6664 - Polyline modal & drawing
- L6695 - Zoom bar & page navigation
- L6734 - Canvas layers
- L6937 - PDF download helpers & PipeTooling menu
- L7013 - Copy summaries (PipeTooling / Email)
- L7215 - Import-canvas-after-PDF & Clear Page modals
- L7391 - Download current page
- L7639 - Zone & page-action modal handlers
- L7743 - Mobile actions burger menu (right-side drawer)
- L7871 - User activity time formatting
- L8029 - User Activity modal (admin)
- L8097 - My Settings modal
- L8128 - Auth & settings entry buttons
  - L8173 - Project Settings checkout & Save Status bell
  - L8291 - [sync] Checkout expired recovery
  - L8545 - [sync] Turn In
  - L9058 - Share project & view links
  - L9278 - Cloud project hydrate / copy / fork
  - L9474 - Settings menu actions & Airboard sync
  - L9553 - My Settings password & Auth sign-in
  - L9606 - Save Project modal
  - L9809 - Copy project modal
  - L9833 - Checkout expired recovery modal wiring
  - L9917 - Save-before-load modal
  - L9992 - Last-session restore prompt
  - L10020 - User Activity filters & view toggle
- L10208 - Canvas Event Handlers
- L10580 - Event Binding
- L10583 - Aim loupe (mobile press-hold precise placement)
- L11585 - [sync] Manual save to cloud
- L12210 - [sync] Auto-save
- L12507 - [sync] Local backup (IndexedDB takeoff state)
- L12733 - [sync] Checkout keep-alive
- L12777 - App feature registry
- L12906 - View-only mode
- L13061 - Init / boot
