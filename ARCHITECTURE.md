...
|------|------:|------------------|
| [app.js](app.js) | 7,463 | **The remaining monolith** — down from 16.2k (9.9k after save-engine Stage 6, 8.1k after the Tier-2 splits, then −987 from the canvas-draw extraction). The only file worth actively shrinking; the region table below says what's left and in what order. |
...
| `features/*.js` (69 files) | 16,622 total | Healthy: largest after load-project are quick-modals (462), user-activity (459), user-admin (453), room-sizer (443), output (416), scale (412) — each single-feature scoped with its own Playwright spec. Leave. |
...
- L2713 - Inline rename & polyline edit mode
- L2827 - Modal primitives (showModal / hideModal)
- L2858 - Toasts & line color picker
- L2926 - Airboard cloud sync
- L2971 - Supabase RPC & presence heartbeat
- L3011 - User activity / event telemetry
- L3070 - Supabase auth & dev auth
- L3256 - [sync] Checkout subscription & permission refresh
- L3266 - Modals & Handlers
- L3334 - PDF intake (upload, test PDF, hashing)
- L3342 - Toolbar tool buttons
- L3542 - Tool sidebar buttons & legend overlay
- L3633 - Add Line Type modal
- L3716 - Line color & sidebar handlers
- L3925 - Polyline modal & drawing
- L3968 - Zoom bar & page navigation
- L3994 - Export canvas JSON
- L4010 - PDF download helpers
- L4019 - View-link URL helpers & show-highlights/notes
- L4091 - Custom icon upload handler
- L4101 - Export & report dropdown menus
- L4188 - Sidebar drawer toggles
- L4219 - Mobile actions burger menu pointer & header logo
- L4231 - User Activity pointer (format.js + features/user-activity.js)
- L4243 - My Settings pointer (features/my-settings.js)
- L4268 - Auth & settings entry buttons
  - L4327 - Project Settings checkout & Save Status bell
  - L4419 - [sync] Checkout expired recovery
  - L4475 - [sync] Turn In
  - L4584 - Share modal pointer & copy-project openers
  - L4615 - Settings menu actions
  - L4636 - Auth sign-in form
  - L4661 - Save Project modal
  - L4674 - Checkout expired recovery modal wiring
  - L4779 - Last-session restore prompt
  - L4786 - Canvas Repair modal wiring
- L4973 - Canvas Event Handlers
- L5425 - Event Binding
- L5435 - Aim loupe (mobile press-hold precise placement)
- L5585 - Zoom transform preview & commit
- L5664 - Canvas mouse, wheel & touch handlers
- L6416 - Global dropdown dismissal & keyboard hotkeys
- L6763 - [sync] Manual save to cloud
- L6773 - [sync] Auto-save
- L6780 - [sync] Local backup (IndexedDB takeoff state)
- L6913 - [sync] Checkout keep-alive
- L6927 - App feature registry
- L7242 - View-only mode
- L7248 - Init / boot
