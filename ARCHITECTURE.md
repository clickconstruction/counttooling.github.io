...
- L4760 - Airboard cloud sync
- L4793 - Supabase RPC & presence heartbeat
- L4833 - User activity / event telemetry
- L4876 - Supabase auth & dev auth
- L5005 - [sync] Checkout subscription & permission refresh
- L5015 - Modals & Handlers
- L5088 - PDF intake (upload, test PDF, hashing)
- L5416 - Toolbar tool buttons
- L5524 - Tool sidebar buttons & legend overlay
- L5638 - Add Line Type modal
- L5708 - Line color & sidebar handlers
- L5850 - Polyline modal & drawing
- L5881 - Zoom bar & page navigation
- L5907 - Export canvas JSON
- L5923 - PDF download helpers
- L5976 - View-link URL helpers & show-highlights/notes
- L6048 - Custom icon upload handler
- L6173 - Export & report dropdown menus
- L6263 - Sidebar drawer toggles
- L6274 - Mobile actions burger menu pointer & header logo
- L6286 - User Activity pointer (format.js + features/user-activity.js)
- L6298 - My Settings pointer (features/my-settings.js)
- L6321 - Auth & settings entry buttons
  - L6366 - Project Settings checkout & Save Status bell
  - L6467 - [sync] Checkout expired recovery
  - L6523 - [sync] Turn In
  - L6802 - Share modal pointer & copy-project openers
  - L6833 - Settings menu actions
  - L6854 - Auth sign-in form
  - L6878 - Save Project modal
  - L6891 - Checkout expired recovery modal wiring
  - L6996 - Last-session restore prompt
  - L7075 - Canvas Repair modal wiring
- L7222 - Canvas Event Handlers
- L7594 - Event Binding
- L7604 - Aim loupe (mobile press-hold precise placement)
- L7742 - Zoom transform preview & commit
- L7778 - Canvas mouse, wheel & touch handlers
- L8399 - Global dropdown dismissal & keyboard hotkeys
- L8627 - [sync] Manual save to cloud
- L8637 - [sync] Auto-save
- L8644 - [sync] Local backup (IndexedDB takeoff state)
- L8777 - [sync] Checkout keep-alive
- L8791 - App feature registry
- L8974 - View-only mode
- L8980 - Init / boot
