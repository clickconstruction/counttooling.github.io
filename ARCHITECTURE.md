...
- L5052 - Inline rename & polyline edit mode
- L5166 - Item detail & properties modals
- L5504 - Toasts & line color picker
- L5652 - Airboard cloud sync
- L5685 - Supabase RPC & presence heartbeat
- L5725 - User activity / event telemetry
- L5768 - Supabase auth & dev auth
- L5897 - [sync] Checkout subscription & permission refresh
- L6075 - Modals & Handlers
- L6148 - PDF intake (upload, test PDF, hashing)
- L6473 - Toolbar tool buttons
- L6581 - Tool sidebar buttons & legend overlay
- L6695 - Add Line Type modal
- L6765 - Line color & sidebar handlers
- L6909 - Polyline modal & drawing
- L6940 - Zoom bar & page navigation
- L6968 - Canvas layers
- L7171 - PDF download helpers & PipeTooling menu
- L7247 - Copy summaries (PipeTooling / Email)
- L7449 - Import-canvas-after-PDF & Clear Page modals
- L7625 - Download current page
- L7873 - Zone & page-action modal handlers
- L7977 - Mobile actions burger menu (right-side drawer)
- L8105 - User activity time formatting
- L8263 - User Activity modal (admin)
- L8331 - My Settings modal
- L8362 - Auth & settings entry buttons
  - L8407 - Project Settings checkout & Save Status bell
  - L8530 - [sync] Checkout expired recovery
  - L8784 - [sync] Turn In
  - L9297 - Share project & view links
  - L9517 - Cloud project hydrate / copy / fork
  - L9713 - Settings menu actions & Airboard sync
  - L9792 - My Settings password & Auth sign-in
  - L9845 - Save Project modal
  - L10048 - Copy project modal
  - L10072 - Checkout expired recovery modal wiring
  - L10156 - Save-before-load modal
  - L10231 - Last-session restore prompt
  - L10310 - User Activity filters & view toggle
- L10498 - Canvas Event Handlers
- L10870 - Event Binding
- L10873 - Aim loupe (mobile press-hold precise placement)
- L11886 - [sync] Manual save to cloud
- L12511 - [sync] Auto-save
- L12808 - [sync] Local backup (IndexedDB takeoff state)
- L13035 - [sync] Checkout keep-alive
- L13079 - App feature registry
- L13221 - View-only mode
- L13392 - Init / boot
