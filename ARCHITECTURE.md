...
- L2393 - Coordinate Helpers
- L2405 - PDF Rendering
- L3649 - UI Render Functions
- L4771 - Inline rename & polyline edit mode
- L4885 - Item detail & properties modals
- L5209 - Toasts & line color picker
- L5357 - Airboard cloud sync
- L5390 - Supabase RPC & presence heartbeat
- L5430 - User activity / event telemetry
- L5473 - Supabase auth & dev auth
- L5594 - [sync] Checkout subscription & permission refresh
- L5772 - Modals & Handlers
- L5845 - PDF intake (upload, test PDF, hashing)
- L6170 - Toolbar tool buttons
- L6278 - Tool sidebar buttons & legend overlay
- L6392 - Add Line Type modal
- L6462 - Line color & sidebar handlers
- L6606 - Polyline modal & drawing
- L6637 - Zoom bar & page navigation
- L6676 - Canvas layers
- L6879 - PDF download helpers & PipeTooling menu
- L6955 - Copy summaries (PipeTooling / Email)
- L7157 - Import-canvas-after-PDF & Clear Page modals
- L7333 - Download current page
- L7581 - Zone & page-action modal handlers
- L7685 - Mobile actions burger menu (right-side drawer)
- L7813 - User activity time formatting
- L7971 - User Activity modal (admin)
- L8039 - My Settings modal
- L8070 - Auth & settings entry buttons
  - L8115 - Project Settings checkout & Save Status bell
  - L8233 - [sync] Checkout expired recovery
  - L8487 - [sync] Turn In
  - L9000 - Share project & view links
  - L9220 - Cloud project hydrate / copy / fork
  - L9416 - Settings menu actions & Airboard sync
  - L9495 - My Settings password & Auth sign-in
  - L9548 - Save Project modal
  - L9751 - Copy project modal
  - L9775 - Checkout expired recovery modal wiring
  - L9859 - Save-before-load modal
  - L9934 - Last-session restore prompt
  - L9962 - User Activity filters & view toggle
- L10150 - Canvas Event Handlers
- L10519 - Event Binding
- L10522 - Aim loupe (mobile press-hold precise placement)
- L11462 - [sync] Manual save to cloud
- L12087 - [sync] Auto-save
- L12384 - [sync] Local backup (IndexedDB takeoff state)
- L12610 - [sync] Checkout keep-alive
- L12654 - App feature registry
- L12780 - View-only mode
- L12935 - Init / boot
