...
- L343 - State
- L580 - [sync] Sync recovery & client recycle
- L979 - [sync] Global force reload
- L1099 - [sync] Save Status log & envelope
- L1243 - [sync] Dirty tracking & local session reset
- L1458 - [sync] Checkout probe, hashing & PDF cache
- L1705 - Math & Format Helpers
- L2386 - Coordinate Helpers
- L2398 - PDF Rendering
- L3602 - UI Render Functions
- L4724 - Inline rename & polyline edit mode
- L4838 - Item detail & properties modals
- L5162 - Toasts & line color picker
- L5310 - Airboard cloud sync
- L5343 - Supabase RPC & presence heartbeat
- L5383 - User activity / event telemetry
- L5426 - Supabase auth & dev auth
- L5547 - [sync] Checkout subscription & permission refresh
- L5725 - Modals & Handlers
- L5798 - PDF intake (upload, test PDF, hashing)
- L6123 - Toolbar tool buttons
- L6230 - Tool sidebar buttons & legend overlay
- L6344 - Add Line Type modal
- L6414 - Line color & sidebar handlers
- L6558 - Polyline modal & drawing
- L6589 - Zoom bar & page navigation
- L6628 - Canvas layers
- L6831 - PDF download helpers & PipeTooling menu
- L6907 - Copy summaries (PipeTooling / Email)
- L7109 - Import-canvas-after-PDF & Clear Page modals
- L7285 - Download current page
- L7533 - Zone & page-action modal handlers
- L7637 - Mobile actions burger menu (right-side drawer)
- L7765 - User activity time formatting
- L7923 - User Activity modal (admin)
- L7991 - My Settings modal
- L8022 - Auth & settings entry buttons
  - L8067 - Project Settings checkout & Save Status bell
  - L8185 - [sync] Checkout expired recovery
  - L8439 - [sync] Turn In
  - L8952 - Share project & view links
  - L9172 - Cloud project hydrate / copy / fork
  - L9368 - Settings menu actions & Airboard sync
  - L9447 - My Settings password & Auth sign-in
  - L9500 - Save Project modal
  - L9703 - Copy project modal
  - L9727 - Checkout expired recovery modal wiring
  - L9811 - Save-before-load modal
  - L9886 - Last-session restore prompt
  - L9914 - User Activity filters & view toggle
- L10102 - Canvas Event Handlers
- L10446 - Event Binding
- L11201 - [sync] Manual save to cloud
- L11826 - [sync] Auto-save
- L12123 - [sync] Local backup (IndexedDB takeoff state)
- L12349 - [sync] Checkout keep-alive
- L12393 - App feature registry
- L12519 - View-only mode
- L12674 - Init / boot
