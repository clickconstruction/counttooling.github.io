...
|------|------:|------------------|
| [app.js](app.js) | 7,105 | **The remaining monolith** — down from 16.2k (9.9k after save-engine Stage 6, 8.1k after the Tier-2 splits, then −987 from the canvas-draw extraction). The only file worth actively shrinking; the region table below says what's left and in what order. |
...
| [app/index.html](app/index.html) | 2,703 | The shell: HTML structure + every modal, no inline JS. Flat markup with no build step to split it; grows roughly linearly with modal count. Leave. |
| [styles.css](styles.css) | 1,601 | All CSS, token-organized. Leave. |
...
| `features/*.js` (64 files) | 14,769 total | Healthy: largest after load-project are quick-modals (462), user-activity (459), user-admin (453), room-sizer (443), output (416), scale (412) — each single-feature scoped with its own Playwright spec. Leave. |
...
- L2623 - Inline rename & polyline edit mode
- L2737 - Modal primitives (showModal / hideModal)
...
- L3104 - [sync] Checkout subscription & permission refresh
- L3114 - Modals & Handlers
- L3182 - PDF intake (upload, test PDF, hashing)
- L3190 - Toolbar tool buttons
- L3362 - Tool sidebar buttons & legend overlay
- L3453 - Add Line Type modal
- L3538 - Line color & sidebar handlers
- L3747 - Polyline modal & drawing
- L3778 - Zoom bar & page navigation
- L3804 - Export canvas JSON
- L3820 - PDF download helpers
- L3829 - View-link URL helpers & show-highlights/notes
- L3901 - Custom icon upload handler
- L3911 - Export & report dropdown menus
- L3998 - Sidebar drawer toggles
- L4009 - Mobile actions burger menu pointer & header logo
- L4021 - User Activity pointer (format.js + features/user-activity.js)
- L4033 - My Settings pointer (features/my-settings.js)
- L4056 - Auth & settings entry buttons
  - L4101 - Project Settings checkout & Save Status bell
  - L4193 - [sync] Checkout expired recovery
  - L4249 - [sync] Turn In
  - L4359 - Share modal pointer & copy-project openers
  - L4390 - Settings menu actions
  - L4411 - Auth sign-in form
  - L4435 - Save Project modal
  - L4448 - Checkout expired recovery modal wiring
  - L4553 - Last-session restore prompt
  - L4560 - Canvas Repair modal wiring
- L4747 - Canvas Event Handlers
- L5193 - Event Binding
- L5203 - Aim loupe (mobile press-hold precise placement)
- L5344 - Zoom transform preview & commit
- L5423 - Canvas mouse, wheel & touch handlers
- L6131 - Global dropdown dismissal & keyboard hotkeys
- L6435 - [sync] Manual save to cloud
- L6445 - [sync] Auto-save
- L6452 - [sync] Local backup (IndexedDB takeoff state)
- L6585 - [sync] Checkout keep-alive
- L6599 - App feature registry
- L6893 - View-only mode
- L6899 - Init / boot
