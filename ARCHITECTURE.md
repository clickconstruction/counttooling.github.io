...
- L580 - [sync] Global force reload
- L663 - [sync] Save Status log & envelope
- L676 - [sync] Dirty tracking & local session reset
- L682 - Undo/redo stacks
- L849 - [sync] Checkout probe, hashing & PDF cache
- L1011 - Math & Format Helpers
- L1800 - Coordinate Helpers
- L1808 - PDF render bitmap cache
- L1975 - PDF Rendering
- L3429 - UI Render Functions
- L4576 - Inline rename & polyline edit mode
- L4690 - Modal primitives (showModal / hideModal)
- L4709 - Toasts & line color picker
- L4857 - Airboard cloud sync
- L4890 - Supabase RPC & presence heartbeat
- L4930 - User activity / event telemetry
- L4973 - Supabase auth & dev auth
- L5102 - [sync] Checkout subscription & permission refresh
- L5112 - Modals & Handlers
- L5185 - PDF intake (upload, test PDF, hashing)
- L5513 - Toolbar tool buttons
- L5621 - Tool sidebar buttons & legend overlay
- L5735 - Add Line Type modal
- L5805 - Line color & sidebar handlers
- L5949 - Polyline modal & drawing
- L5980 - Zoom bar & page navigation
- L6006 - Export canvas JSON
- L6022 - PDF download helpers
- L6075 - View-link URL helpers & show-highlights/notes
- L6147 - Custom icon upload handler
- L6272 - Export & report dropdown menus
- L6362 - Sidebar drawer toggles
- L6373 - Mobile actions burger menu pointer & header logo
- L6385 - User Activity pointer (format.js + features/user-activity.js)
- L6397 - My Settings pointer (features/my-settings.js)
- L6420 - Auth & settings entry buttons
  - L6465 - Project Settings checkout & Save Status bell
  - L6566 - [sync] Checkout expired recovery
  - L6622 - [sync] Turn In
  - L6901 - Share modal pointer & copy-project openers
  - L6944 - Cloud project hydrate / copy / fork
  - L7141 - Settings menu actions
  - L7162 - Auth sign-in form
  - L7186 - Save Project modal
  - L7389 - Copy project modal
  - L7413 - Checkout expired recovery modal wiring
  - L7497 - Save-before-load modal
  - L7572 - Last-session restore prompt
  - L7651 - Canvas Repair modal wiring
- L7798 - Canvas Event Handlers
- L8170 - Event Binding
- L8180 - Aim loupe (mobile press-hold precise placement)
- L8318 - Zoom transform preview & commit
- L8354 - Canvas mouse, wheel & touch handlers
- L8975 - Global dropdown dismissal & keyboard hotkeys
- L9203 - [sync] Manual save to cloud
- L9213 - [sync] Auto-save
- L9220 - [sync] Local backup (IndexedDB takeoff state)
- L9353 - [sync] Checkout keep-alive
- L9367 - App feature registry
- L9541 - View-only mode
- L9822 - Init / boot
