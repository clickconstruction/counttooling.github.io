...
|------|------:|------------------|
| [app.js](app.js) | 7,303 | **The remaining monolith** — down from 16.2k (9.9k after save-engine Stage 6, 8.1k after the Tier-2 splits, then −987 from the canvas-draw extraction). The only file worth actively shrinking; the region table below says what's left and in what order. |
...
| [app/index.html](app/index.html) | 2,784 | The shell: HTML structure + every modal, no inline JS. Flat markup with no build step to split it; grows roughly linearly with modal count. Leave. |
| [styles.css](styles.css) | 1,716 | All CSS, token-organized. Leave. |
...
| `features/*.js` (68 files) | 15,983 total | Healthy: largest after load-project are quick-modals (462), user-activity (459), user-admin (453), room-sizer (443), output (416), scale (412) — each single-feature scoped with its own Playwright spec. Leave. |
...
- L2652 - Inline rename & polyline edit mode
- L2766 - Modal primitives (showModal / hideModal)
- L2797 - Toasts & line color picker
- L2864 - Airboard cloud sync
- L2909 - Supabase RPC & presence heartbeat
- L2949 - User activity / event telemetry
- L3008 - Supabase auth & dev auth
- L3152 - [sync] Checkout subscription & permission refresh
- L3162 - Modals & Handlers
- L3230 - PDF intake (upload, test PDF, hashing)
- L3238 - Toolbar tool buttons
- L3438 - Tool sidebar buttons & legend overlay
- L3529 - Add Line Type modal
- L3612 - Line color & sidebar handlers
- L3821 - Polyline modal & drawing
- L3864 - Zoom bar & page navigation
- L3890 - Export canvas JSON
- L3906 - PDF download helpers
- L3915 - View-link URL helpers & show-highlights/notes
- L3987 - Custom icon upload handler
- L3997 - Export & report dropdown menus
- L4084 - Sidebar drawer toggles
- L4095 - Mobile actions burger menu pointer & header logo
- L4107 - User Activity pointer (format.js + features/user-activity.js)
- L4119 - My Settings pointer (features/my-settings.js)
- L4144 - Auth & settings entry buttons
  - L4189 - Project Settings checkout & Save Status bell
  - L4281 - [sync] Checkout expired recovery
  - L4337 - [sync] Turn In
  - L4446 - Share modal pointer & copy-project openers
  - L4477 - Settings menu actions
  - L4498 - Auth sign-in form
  - L4523 - Save Project modal
  - L4536 - Checkout expired recovery modal wiring
  - L4641 - Last-session restore prompt
  - L4648 - Canvas Repair modal wiring
- L4835 - Canvas Event Handlers
- L5287 - Event Binding
- L5297 - Aim loupe (mobile press-hold precise placement)
- L5447 - Zoom transform preview & commit
- L5526 - Canvas mouse, wheel & touch handlers
- L6278 - Global dropdown dismissal & keyboard hotkeys
- L6620 - [sync] Manual save to cloud
- L6630 - [sync] Auto-save
- L6637 - [sync] Local backup (IndexedDB takeoff state)
- L6770 - [sync] Checkout keep-alive
- L6784 - App feature registry
- L7090 - View-only mode
- L7096 - Init / boot
