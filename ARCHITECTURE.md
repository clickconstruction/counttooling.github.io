...
|------|------:|------------------|
| [app.js](app.js) | 6,681 | **The remaining monolith** — down from 16.2k (9.9k after save-engine Stage 6, 8.1k after the Tier-2 splits, then −987 from the canvas-draw extraction). The only file worth actively shrinking; the region table below says what's left and in what order. |
...
| `features/*.js` (49 files) | 11,210 total | Healthy: largest after load-project are quick-modals (462), user-activity (459), user-admin (453), room-sizer (443), output (416), scale (412) — each single-feature scoped with its own Playwright spec. Leave. |
...
- L1218 - Sharp crop tile (deep-zoom sharpening + window-first commits)
- L1229 - PDF Rendering
- L1908 - UI Render Functions
- L2454 - Inline rename & polyline edit mode
- L2568 - Modal primitives (showModal / hideModal)
- L2587 - Toasts & line color picker
- L2641 - Airboard cloud sync
- L2683 - Supabase RPC & presence heartbeat
- L2723 - User activity / event telemetry
- L2766 - Supabase auth & dev auth
- L2898 - [sync] Checkout subscription & permission refresh
- L2908 - Modals & Handlers
- L2976 - PDF intake (upload, test PDF, hashing)
- L2984 - Toolbar tool buttons
- L3110 - Tool sidebar buttons & legend overlay
- L3228 - Add Line Type modal
- L3298 - Line color & sidebar handlers
- L3440 - Polyline modal & drawing
- L3471 - Zoom bar & page navigation
- L3497 - Export canvas JSON
- L3513 - PDF download helpers
- L3522 - View-link URL helpers & show-highlights/notes
- L3594 - Custom icon upload handler
- L3604 - Export & report dropdown menus
- L3693 - Sidebar drawer toggles
- L3704 - Mobile actions burger menu pointer & header logo
- L3716 - User Activity pointer (format.js + features/user-activity.js)
- L3728 - My Settings pointer (features/my-settings.js)
- L3751 - Auth & settings entry buttons
  - L3796 - Project Settings checkout & Save Status bell
  - L3897 - [sync] Checkout expired recovery
  - L3953 - [sync] Turn In
  - L4218 - Share modal pointer & copy-project openers
  - L4249 - Settings menu actions
  - L4270 - Auth sign-in form
  - L4294 - Save Project modal
  - L4307 - Checkout expired recovery modal wiring
  - L4412 - Last-session restore prompt
  - L4419 - Canvas Repair modal wiring
- L4572 - Canvas Event Handlers
- L4962 - Event Binding
- L4972 - Aim loupe (mobile press-hold precise placement)
- L5111 - Zoom transform preview & commit
- L5190 - Canvas mouse, wheel & touch handlers
- L5851 - Global dropdown dismissal & keyboard hotkeys
- L6111 - [sync] Manual save to cloud
- L6121 - [sync] Auto-save
- L6128 - [sync] Local backup (IndexedDB takeoff state)
- L6261 - [sync] Checkout keep-alive
- L6275 - App feature registry
- L6504 - View-only mode
- L6510 - Init / boot
