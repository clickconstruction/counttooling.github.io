...
- L983 - [sync] Global force reload
- L1106 - [sync] Save Status log & envelope
- L1250 - [sync] Dirty tracking & local session reset
- L1465 - [sync] Checkout probe, hashing & PDF cache
- L1712 - Math & Format Helpers
- L2449 - Coordinate Helpers
- L2461 - PDF Rendering
- L3743 - UI Render Functions
- L4866 - Inline rename & polyline edit mode
- L4980 - Item detail & properties modals
- L5318 - Toasts & line color picker
- L5466 - Airboard cloud sync
- L5499 - Supabase RPC & presence heartbeat
- L5539 - User activity / event telemetry
- L5582 - Supabase auth & dev auth
- L5703 - [sync] Checkout subscription & permission refresh
- L5881 - Modals & Handlers
- L5954 - PDF intake (upload, test PDF, hashing)
- L6279 - Toolbar tool buttons
- L6387 - Tool sidebar buttons & legend overlay
- L6501 - Add Line Type modal
- L6571 - Line color & sidebar handlers
- L6715 - Polyline modal & drawing
- L6746 - Zoom bar & page navigation
- L6786 - Canvas layers
- L6989 - PDF download helpers & PipeTooling menu
- L7065 - Copy summaries (PipeTooling / Email)
- L7267 - Import-canvas-after-PDF & Clear Page modals
- L7443 - Download current page
- L7691 - Zone & page-action modal handlers
- L7795 - Mobile actions burger menu (right-side drawer)
- L7923 - User activity time formatting
- L8081 - User Activity modal (admin)
- L8149 - My Settings modal
- L8180 - Auth & settings entry buttons
  - L8225 - Project Settings checkout & Save Status bell
  - L8343 - [sync] Checkout expired recovery
  - L8597 - [sync] Turn In
  - L9110 - Share project & view links
  - L9330 - Cloud project hydrate / copy / fork
  - L9526 - Settings menu actions & Airboard sync
  - L9605 - My Settings password & Auth sign-in
  - L9658 - Save Project modal
  - L9861 - Copy project modal
  - L9885 - Checkout expired recovery modal wiring
  - L9969 - Save-before-load modal
  - L10044 - Last-session restore prompt
  - L10072 - User Activity filters & view toggle
- L10260 - Canvas Event Handlers
- L10632 - Event Binding
- L10635 - Aim loupe (mobile press-hold precise placement)
- L11647 - [sync] Manual save to cloud
- L12272 - [sync] Auto-save
- L12569 - [sync] Local backup (IndexedDB takeoff state)
- L12795 - [sync] Checkout keep-alive
- L12839 - App feature registry
- L12968 - View-only mode
- L13123 - Init / boot
