...
- L343 - State
- L578 - [sync] Sync recovery & client recycle
- L977 - [sync] Global force reload
- L1097 - [sync] Save Status log & envelope
- L1241 - [sync] Dirty tracking & local session reset
- L1456 - [sync] Checkout probe, hashing & PDF cache
- L1703 - Math & Format Helpers
- L2384 - Coordinate Helpers
- L2396 - PDF Rendering
- L3568 - UI Render Functions
- L4687 - Inline rename & polyline edit mode
- L4801 - Item detail & properties modals
- L5125 - Toasts & line color picker
- L5273 - Airboard cloud sync
- L5306 - Supabase RPC & presence heartbeat
- L5346 - User activity / event telemetry
- L5389 - Supabase auth & dev auth
- L5510 - [sync] Checkout subscription & permission refresh
- L5688 - Modals & Handlers
- L5761 - PDF intake (upload, test PDF, hashing)
- L6086 - Toolbar tool buttons
- L6193 - Tool sidebar buttons & legend overlay
- L6307 - Add Line Type modal
- L6377 - Line color & sidebar handlers
- L6521 - Polyline modal & drawing
- L6552 - Zoom bar & page navigation
- L6591 - Canvas layers
- L6794 - PDF download helpers & PipeTooling menu
- L6870 - Copy summaries (PipeTooling / Email)
- L7072 - Import-canvas-after-PDF & Clear Page modals
- L7248 - Download current page
- L7496 - Zone & page-action modal handlers
- L7606 - User activity time formatting
- L7764 - User Activity modal (admin)
- L7832 - My Settings modal
- L7863 - Auth & settings entry buttons
  - L7906 - Project Settings checkout & Save Status bell
  - L8024 - [sync] Checkout expired recovery
  - L8278 - [sync] Turn In
  - L8791 - Share project & view links
  - L9011 - Cloud project hydrate / copy / fork
  - L9207 - Settings menu actions & Airboard sync
  - L9286 - My Settings password & Auth sign-in
  - L9339 - Save Project modal
  - L9542 - Copy project modal
  - L9566 - Checkout expired recovery modal wiring
  - L9650 - Save-before-load modal
  - L9725 - Last-session restore prompt
  - L9753 - User Activity filters & view toggle
- L9941 - Canvas Event Handlers
- L10285 - Event Binding
- L11040 - [sync] Manual save to cloud
- L11665 - [sync] Auto-save
- L11962 - [sync] Local backup (IndexedDB takeoff state)
- L12188 - [sync] Checkout keep-alive
- L12232 - App feature registry
- L12358 - View-only mode
- L12511 - Init / boot
...
- **View links** — `project_view_links` + `view_link_access_log`; Share modal
  ...
  revoking a link clears the export's prefetch cache.
