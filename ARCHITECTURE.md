...
| Macros / Keyboard Shortcuts | `macrosModal` or `statusBarMacros` — modal listing M/S/C/L/J/P/D/H/N/R/Esc/arrows (Left/Right page, Up/Down canvas when multiple)/Enter/Ctrl+Z/Ctrl+Shift+Z/Ctrl+R; Shift+C (Quick tab when Counter modal open); Shift+L (Quick tab when Line modal open) |
