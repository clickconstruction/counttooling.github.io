...
- **Line Type Settings** — Click "Line Types" heading: opacity, line size, drop X size (4–24px), drop icon (Circle default, X, Plus, Diamond, Triangle), Orient length with line direction toggle, Parallel ends (4–64px), Length label size (8–24px), Snap to horizontal/vertical toggle
