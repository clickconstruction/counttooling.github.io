...
|------|------:|------------------|
| [app.js](app.js) | 6,723 | **The remaining monolith** — down from 16.2k (9.9k after save-engine Stage 6, 8.1k after the Tier-2 splits, then −987 from the canvas-draw extraction). The only file worth actively shrinking; the region table below says what's left and in what order. |
...
| [styles.css](styles.css) | 1,441 | All CSS, token-organized. Leave. |
...
- L3575 - Polyline modal & drawing
- L3606 - Zoom bar & page navigation
- L3632 - Export canvas JSON
- L3648 - PDF download helpers
- L3657 - View-link URL helpers & show-highlights/notes
- L3729 - Custom icon upload handler
- L3739 - Export & report dropdown menus
- L3826 - Sidebar drawer toggles
- L3837 - Mobile actions burger menu pointer & header logo
- L3849 - User Activity pointer (format.js + features/user-activity.js)
- L3861 - My Settings pointer (features/my-settings.js)
- L3884 - Auth & settings entry buttons
  - L3929 - Project Settings checkout & Save Status bell
  - L4030 - [sync] Checkout expired recovery
  - L4086 - [sync] Turn In
  - L4188 - Share modal pointer & copy-project openers
  - L4219 - Settings menu actions
  - L4240 - Auth sign-in form
  - L4264 - Save Project modal
  - L4277 - Checkout expired recovery modal wiring
  - L4382 - Last-session restore prompt
  - L4389 - Canvas Repair modal wiring
- L4542 - Canvas Event Handlers
- L4936 - Event Binding
- L4946 - Aim loupe (mobile press-hold precise placement)
- L5085 - Zoom transform preview & commit
- L5164 - Canvas mouse, wheel & touch handlers
- L5825 - Global dropdown dismissal & keyboard hotkeys
- L6087 - [sync] Manual save to cloud
- L6097 - [sync] Auto-save
- L6104 - [sync] Local backup (IndexedDB takeoff state)
- L6237 - [sync] Checkout keep-alive
- L6251 - App feature registry
- L6512 - View-only mode
- L6518 - Init / boot
...
- **Sidebar usage filter (off / sheet / project)** — the inline **funnel**
  ...
  narrate the state, and each cycle click fires a three-line toast —
  "Filter:" / landed state / dimmed next-click hint — via
  `showFilterScopeToast`, whose `showFilterToast` core the two-state Lines
  toggle reuses). The chosen scope
