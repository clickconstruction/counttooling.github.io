...
- L2743 - Supabase RPC & presence heartbeat
- L2783 - User activity / event telemetry
- L2826 - Supabase auth & dev auth
- L2958 - [sync] Checkout subscription & permission refresh
- L2968 - Modals & Handlers
- L3036 - PDF intake (upload, test PDF, hashing)
- L3044 - Toolbar tool buttons
