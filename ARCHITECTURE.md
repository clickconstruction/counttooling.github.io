...
|------|------:|------------------|
| [app.js](app.js) | 7,453 | **The remaining monolith** — down from 16.2k (9.9k after save-engine Stage 6, 8.1k after the Tier-2 splits, then −987 from the canvas-draw extraction). The only file worth actively shrinking; the region table below says what's left and in what order. |
...
| [styles.css](styles.css) | 1,792 | All CSS, token-organized. Leave. |
...
| `features/*.js` (69 files) | 16,582 total | Healthy: largest after load-project are quick-modals (462), user-activity (459), user-admin (453), room-sizer (443), output (416), scale (412) — each single-feature scoped with its own Playwright spec. Leave. |
...
- L2703 - Inline rename & polyline edit mode
- L2817 - Modal primitives (showModal / hideModal)
- L2848 - Toasts & line color picker
- L2916 - Airboard cloud sync
- L2961 - Supabase RPC & presence heartbeat
- L3001 - User activity / event telemetry
- L3060 - Supabase auth & dev auth
- L3246 - [sync] Checkout subscription & permission refresh
- L3256 - Modals & Handlers
- L3324 - PDF intake (upload, test PDF, hashing)
- L3332 - Toolbar tool buttons
- L3532 - Tool sidebar buttons & legend overlay
- L3623 - Add Line Type modal
- L3706 - Line color & sidebar handlers
- L3915 - Polyline modal & drawing
- L3958 - Zoom bar & page navigation
- L3984 - Export canvas JSON
- L4000 - PDF download helpers
- L4009 - View-link URL helpers & show-highlights/notes
- L4081 - Custom icon upload handler
- L4091 - Export & report dropdown menus
- L4178 - Sidebar drawer toggles
- L4209 - Mobile actions burger menu pointer & header logo
- L4221 - User Activity pointer (format.js + features/user-activity.js)
- L4233 - My Settings pointer (features/my-settings.js)
- L4258 - Auth & settings entry buttons
  - L4317 - Project Settings checkout & Save Status bell
  - L4409 - [sync] Checkout expired recovery
  - L4465 - [sync] Turn In
  - L4574 - Share modal pointer & copy-project openers
  - L4605 - Settings menu actions
  - L4626 - Auth sign-in form
  - L4651 - Save Project modal
  - L4664 - Checkout expired recovery modal wiring
  - L4769 - Last-session restore prompt
  - L4776 - Canvas Repair modal wiring
- L4963 - Canvas Event Handlers
- L5415 - Event Binding
- L5425 - Aim loupe (mobile press-hold precise placement)
- L5575 - Zoom transform preview & commit
- L5654 - Canvas mouse, wheel & touch handlers
- L6406 - Global dropdown dismissal & keyboard hotkeys
- L6753 - [sync] Manual save to cloud
- L6763 - [sync] Auto-save
- L6770 - [sync] Local backup (IndexedDB takeoff state)
- L6903 - [sync] Checkout keep-alive
- L6917 - App feature registry
- L7232 - View-only mode
- L7238 - Init / boot
