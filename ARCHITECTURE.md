...
- L6869 - Copy summaries (PipeTooling / Email)
- L7004 - Import-canvas-after-PDF & Clear Page modals
- L7180 - Download current page
- L7428 - Zone & page-action modal handlers
- L7538 - User activity time formatting
- L7696 - User Activity modal (admin)
- L7764 - My Settings modal
- L7795 - Auth & settings entry buttons
  - L7838 - Project Settings checkout & Save Status bell
  - L7968 - [sync] Checkout expired recovery
  - L8222 - [sync] Turn In
  - L8735 - Share project & view links
  - L8955 - Cloud project hydrate / copy / fork
  - L9151 - Settings menu actions & Airboard sync
  - L9230 - My Settings password & Auth sign-in
  - L9283 - Save Project modal
  - L9486 - Copy project modal
  - L9510 - Checkout expired recovery modal wiring
  - L9594 - Save-before-load modal
  - L9669 - Last-session restore prompt
  - L9697 - User Activity filters & view toggle
- L9885 - Canvas Event Handlers
- L10229 - Event Binding
- L10984 - [sync] Manual save to cloud
- L11609 - [sync] Auto-save
- L11906 - [sync] Local backup (IndexedDB takeoff state)
- L12132 - [sync] Checkout keep-alive
- L12176 - App feature registry
- L12302 - View-only mode
- L12455 - Init / boot
