...
- L6735 - Canvas layers
- L6938 - PDF download helpers & PipeTooling menu
- L7014 - Copy summaries (PipeTooling / Email)
- L7216 - Import-canvas-after-PDF & Clear Page modals
- L7392 - Download current page
- L7640 - Zone & page-action modal handlers
- L7744 - Mobile actions burger menu (right-side drawer)
- L7872 - User activity time formatting
- L8030 - User Activity modal (admin)
- L8098 - My Settings modal
- L8129 - Auth & settings entry buttons
  - L8174 - Project Settings checkout & Save Status bell
  - L8292 - [sync] Checkout expired recovery
  - L8546 - [sync] Turn In
  - L9059 - Share project & view links
  - L9279 - Cloud project hydrate / copy / fork
  - L9475 - Settings menu actions & Airboard sync
  - L9554 - My Settings password & Auth sign-in
  - L9607 - Save Project modal
  - L9810 - Copy project modal
  - L9834 - Checkout expired recovery modal wiring
  - L9918 - Save-before-load modal
  - L9993 - Last-session restore prompt
  - L10021 - User Activity filters & view toggle
- L10209 - Canvas Event Handlers
- L10581 - Event Binding
- L10584 - Aim loupe (mobile press-hold precise placement)
- L11586 - [sync] Manual save to cloud
- L12211 - [sync] Auto-save
- L12508 - [sync] Local backup (IndexedDB takeoff state)
- L12734 - [sync] Checkout keep-alive
- L12778 - App feature registry
- L12907 - View-only mode
- L13062 - Init / boot
