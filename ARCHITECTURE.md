...
- L1508 - Sharp crop tile (deep-zoom sharpening + window-first commits)
- L1661 - PDF Rendering
- L2307 - UI Render Functions
- L3384 - Inline rename & polyline edit mode
- L3498 - Modal primitives (showModal / hideModal)
- L3517 - Toasts & line color picker
- L3571 - Airboard cloud sync
- L3604 - Supabase RPC & presence heartbeat
- L3644 - User activity / event telemetry
- L3687 - Supabase auth & dev auth
- L3816 - [sync] Checkout subscription & permission refresh
- L3826 - Modals & Handlers
- L3894 - PDF intake (upload, test PDF, hashing)
- L3902 - Toolbar tool buttons
- L4028 - Tool sidebar buttons & legend overlay
- L4145 - Add Line Type modal
- L4215 - Line color & sidebar handlers
- L4357 - Polyline modal & drawing
- L4388 - Zoom bar & page navigation
- L4414 - Export canvas JSON
- L4430 - PDF download helpers
- L4439 - View-link URL helpers & show-highlights/notes
- L4511 - Custom icon upload handler
- L4521 - Export & report dropdown menus
- L4611 - Sidebar drawer toggles
- L4622 - Mobile actions burger menu pointer & header logo
- L4634 - User Activity pointer (format.js + features/user-activity.js)
- L4646 - My Settings pointer (features/my-settings.js)
- L4669 - Auth & settings entry buttons
  - L4714 - Project Settings checkout & Save Status bell
  - L4815 - [sync] Checkout expired recovery
  - L4871 - [sync] Turn In
  - L5136 - Share modal pointer & copy-project openers
  - L5167 - Settings menu actions
  - L5188 - Auth sign-in form
  - L5212 - Save Project modal
  - L5225 - Checkout expired recovery modal wiring
  - L5330 - Last-session restore prompt
  - L5337 - Canvas Repair modal wiring
- L5488 - Canvas Event Handlers
- L5878 - Event Binding
- L5888 - Aim loupe (mobile press-hold precise placement)
- L6027 - Zoom transform preview & commit
- L6106 - Canvas mouse, wheel & touch handlers
- L6764 - Global dropdown dismissal & keyboard hotkeys
- L6999 - [sync] Manual save to cloud
- L7009 - [sync] Auto-save
- L7016 - [sync] Local backup (IndexedDB takeoff state)
- L7149 - [sync] Checkout keep-alive
- L7163 - App feature registry
- L7359 - View-only mode
- L7365 - Init / boot
