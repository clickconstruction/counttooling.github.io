...
- L6417 - Auth & settings entry buttons
  ...
  - L7178 - Checkout expired recovery modal wiring
  - L7283 - Last-session restore prompt
  - L7362 - Canvas Repair modal wiring
- L7509 - Canvas Event Handlers
- L7881 - Event Binding
- L7891 - Aim loupe (mobile press-hold precise placement)
- L8029 - Zoom transform preview & commit
- L8065 - Canvas mouse, wheel & touch handlers
- L8686 - Global dropdown dismissal & keyboard hotkeys
- L8914 - [sync] Manual save to cloud
- L8924 - [sync] Auto-save
- L8931 - [sync] Local backup (IndexedDB takeoff state)
- L9064 - [sync] Checkout keep-alive
- L9078 - App feature registry
- L9257 - View-only mode
- L9263 - Init / boot
