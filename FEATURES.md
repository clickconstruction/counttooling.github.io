...
- **Check-out / turn-in (one editor at a time)** — Two people can never save over each other; the lock frees itself after 30 idle minutes so a project is never stuck. Turning in offers Close project right on the confirmation, and the same door sits at the foot of the header cloud menu — no more reloading the tab to get out.
