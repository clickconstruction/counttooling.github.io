...
- **Two sample plans**: the simple plan (an office TI, the sheet the three five-minute tours walk) and the advanced plan (a restaurant plumbing sheet: dining, bar, kitchen, dish, restrooms, a grease interceptor, keynotes), both one click from the empty canvas or Project Settings and opened through the ordinary intake.
