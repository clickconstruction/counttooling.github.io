...
| G5 | counting-with-counters.md / custom-icons.md | Settings → Advanced → Manage Icons gate REMOVED entirely 2026-08-20 (desktop ungated to match mobile); guides updated to match (J4); the Quick-tab "−" button edits your saved profile list, no confirm (J4) |
