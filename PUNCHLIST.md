...
| P4-WATER | Water sizing by fixture units: the six rungs are built on the stacked PRs #181 → #183 → #184 → #186 → #187 → #188 (2026-09-23); merge the stack in order, then close this row | build | dev | — | [WATER-PLAN.md](journeys/plans/WATER-PLAN.md) |
