...
| BEND-FITTINGS | Fittings from bends: a per-line-type table (bend nearer 45° → fitting × qty, nearer 90° → …, drop at an end → …) derives elbow rows from a run's own vertices and drops, chips at the bends, a Bid Check row beside the hangers (Robert, 2026-09-18; mockup https://claude.ai/artifact/6Gj27nuq1uYh9BZjeSPm82) | build | agent | — | [WATER-PLAN.md](journeys/plans/WATER-PLAN.md) |
