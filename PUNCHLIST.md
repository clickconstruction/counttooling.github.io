...
| PERSONA-CALIBRATE | Run the personas on the plumbing tour at the commit before #199 and score them against the six by-hand walks' findings (recall and noise) before any persona output is trusted | test | agent | — | [PERSONA-PLAN.md](journeys/plans/PERSONA-PLAN.md#runs) |
