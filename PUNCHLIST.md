...
| DUCT-HINT | The Duct tool's suggestion line ("600 CFM downstream · suggests 16×8 … S accepts") is drawn on the cursor's own row and across the trace, covering the next click and the diffusers; move it to a card fixed above the footer, keep only the size chip at the cursor (Robert, 2026-09-18, from the HVAC film) | bug | agent | — | [LANDING-REFRESH.md](journeys/plans/LANDING-REFRESH.md#the-per-trade-films-2026-09-17-in-progress) |
