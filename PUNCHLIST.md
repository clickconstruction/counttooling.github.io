...
| LEARN-LESSONS | The Learn menu and its thirteen short lessons on the engineered sample plan, dormant behind `?ff=learn` | build | agent | — | [LEARN-PLAN.md](journeys/plans/LEARN-PLAN.md#the-lessons) |
