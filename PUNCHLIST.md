...
| FILM-FIXTURES | Plumbing hero film: the caption says "Nothing missed." but four fixtures the sheet draws are never counted: the lavatory in MEN 102 and in WOMEN 103, and the two floor sinks (in front of PREP, and by the clean table in DISH). Add the counters to `recordPlumbing`, re-render the film (its chapters file and the landing's numbers follow by themselves), and re-cut the plumbing spotlight frames if their tallies change | bug | agent | — | [LANDING-REFRESH.md](journeys/plans/LANDING-REFRESH.md#the-hero-chapters-plan-of-record-2026-09-19) |
