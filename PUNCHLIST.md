...
| BEND-OVERRIDE | Fittings from bends: the edit-mode vertex menu ("No fitting here" / "Count as 45" / "Count as 90") that writes `points[i].fitting`; the model already honours it, the menu does not exist yet | build | agent | — | [WATER-PLAN.md](journeys/plans/WATER-PLAN.md#6-suggested-build-ladder-after-the-mockup-round) |
