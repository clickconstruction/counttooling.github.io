...
| PERSONA-FIXES | The seven plumbing-tour defects the calibration found still open on main (C2 C3 C4 C7 C9 C21 C23: the Chain palette under the card, a Drop click with no run end, touch losing the size step, "the plumbing set", the unnamed drop palette, IPC never spelled out, the SUMMARY heading) | bug | agent | — | [PERSONA-PLAN.md](journeys/plans/PERSONA-PLAN.md#calibration-results-2026-09-25) |
