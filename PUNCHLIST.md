...
| R2 | Migration: 13 client event types 400 against the deployed `log_user_event` allowlist, plus a drift test | build | dev | ⚑ Will's go | [_TODO.md](journeys/plans/_TODO.md#r2--13-client-event-types-400-against-the-deployed-log_user_event-allowlist) |
