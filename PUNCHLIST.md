...
| HERO-EHVAC | The hero chip switching that selects a trade's film (all three films landed 2026-09-17), then retire the three-trade take | build | agent | — | [LANDING-REFRESH.md](journeys/plans/LANDING-REFRESH.md#the-remaining-scripts) |
