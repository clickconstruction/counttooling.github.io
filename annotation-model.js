...
function createAnnotationModel(ctx) {
  ...
  function applyTakeoffBackupToState(backup) {
    ...
    if (backup.waterSettings) ctx.getState().waterSettings = { ...ctx.getState().waterSettings, ...backup.waterSettings };   // WATER-PLAN rung 5
  ...
  function hydrateStateFromProjectData(d) {
    ...
    if (d.waterSettings) state.waterSettings = { ...state.waterSettings, ...d.waterSettings };   // WATER-PLAN rung 5
