  ...
  function renderAnnotationsInner() {
    ...
    canvasDraw.drawAnnotationsCore(ctx, ann, {
      ...
      // D4 duct-sidebar row selection: live-only glow on the selected run.
      selectedDuctRunId: state.selectedDuctRunId && state.currentPage === state.selectedDuctRunPageIdx ? state.selectedDuctRunId : null,
