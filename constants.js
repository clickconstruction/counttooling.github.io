...
const TOOL = { NONE: 0, SCALE: 1, LINE: 2, POLYLINE: 3, COUNTER: 4, EDIT_POLY: 5, MEASURE: 6, HIGHLIGHT: 7, NOTE: 8, MULTIPLY_ZONE: 9, DELETE_ZONE: 10, SCALE_ZONE: 11, ROOM: 12, CHAIN: 13, GHOST: 14, DROP: 15, DUCT: 16, SCHEDULE: 17 };   // SCHEDULE (S6): drag a box over a fixture schedule → counters
...
function normalizeProjectCodes(raw) {
  ...
  // WATER-PLAN rung 1: the fixture-unit column the project reads (public | private).
...
// After OUR OWN check_in_project succeeds (Turn In, close, load another,
// sign-out), the realtime UPDATE + the post-release permissions refresh both
// see "was editor, now viewer, lock not stale" — the shape of an external
// force. Any refresh inside this window is our own release, not a force
// (field report 2026-09-15: "keeps kicking me to view only" was the Turn In
// button's own tab getting the "an admin turned this in" notice).
const SELF_RELEASE_GRACE_MS = 15 * 1000;
...
// Ghost overlay opacity. Low enough to read instantly as "not part of the
// takeoff", high enough to trace against at working zoom.
...
if (typeof module !== 'undefined' && module.exports) {
  module.exports = {
    ...
    CHECKOUT_KEEPALIVE_MS, CHECKOUT_NEAR_EXPIRY_MS, CHECKOUT_SOFT_GRACE_MS, AUTO_RECHECKOUT_MAX_PER_PROJECT, SELF_RELEASE_GRACE_MS,
    ...
    PENDING_GLOBAL_RELOAD_STAMP_KEY, UNDO_STACK_SIZE, GHOST_ALPHA, PDF_CACHE_DB, PDF_CACHE_STORE, PDF_CACHE_META_STORE, VIEW_PDFS_STORE, VIEW_PDFS_META_STORE,
