...
- **Starting size from the plan.** Point at the trunk you're about to trace and press Duct: if a size callout sits within about 60 points of the cursor (`24x12`, `24×12`, `24"x12"`, `24/12`, `12"Ø`, `12" DIA`, `Ø12`, any of the usual spellings), the create dialog opens pre-filled from it and says so: *"from the plan: 24×12 near the cursor."* With no callout nearby, a sheet that prints exactly one duct size (say `24x12` beside every leg of the trunk) still seeds the dialog, *"from the plan: 24×12, the plan's only printed size"*, while a sheet printing two or more sizes leaves the fields as they were and lets the step-downs below do the reading. Change it if the sheet says otherwise.
