...
- **Copy to /Tooling** to drop the counts straight into a bid — tab-delimited and ready to paste — or **Copy Summary (Email/Text)** for a plain-text rundown you can drop into an email.
