...
description: Add CountTooling to your device for a one-tap icon, and keep working on a takeoff with no connection — built for the job site, not just the office.
updated: 2026-06-10
order: 8
icon: save-status
...
![A CountTooling takeoff — counters on every fixture, a measured waste line, and a live tally in the sidebar. Once installed, this is what opens full-screen from your home screen.](/guides/img/plan-takeoff.png)
...
The **Save status** [[save-status]] indicator in the top bar tells you where things stand — it shows when your work is saved locally and synced to the cloud, so you're never guessing.

![The Save & sync status indicator (highlighted) in the header shows when your work is saved locally and synced to the cloud.](/guides/img/offline-save-status.png)
