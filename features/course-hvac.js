    ...
    // 3 --------------------------------------------------------------------------------------------
    {
      ...
      steps: [
        ...
        { id: 'dining', title: 'Fill the dining room', kind: 'do', cardAt: 'bl', page: M101, zones: () => circlesOn(M101, byTag('SD-1'), pts(G.SD1).slice(0, 8)),
          ...
          target: ['#annCanvas', '#countersList', '#pagesList'], check: () => allDone(circlesOn(M101, byTag('SD-1'), pts(G.SD1).slice(0, 8))),
    ...
    // 7 --------------------------------------------------------------------------------------------
    {
      ...
      steps: [
        ...
        { id: 'makeup', title: 'The make-up air', kind: 'do', cardAt: 'tl', page: M101, zones: () => traceZones(pts(G.makeup), M101),
          ...
          target: ['#ductCreateStart', '#ductBtn', '#annCanvas', '#countersList'], check: () => !!runWith(['20x16']) && markNear(byTag('MA-1'), pts(G.MA1)[0], 12, M101),
