    ...
    // 2 -------------------------------------------------------------------------------------
    {
      ...
      steps: [
        ...
        { id: 'restrooms', title: 'Count the restrooms', kind: 'do', cardAt: 'bl', page: 0, zones: restroomZones,
          ...
          target: ['#annCanvas', '#countersList', '#pagesList'], check: () => allDone(restroomZones()),
        ...
        { id: 'primers', title: 'What the FD keynote costs', kind: 'do',
          rulesExempt: 'no rulebook entry: IPC 802 indirect waste, IPC 1002.4 trap primers',
    ...
    // 4 -------------------------------------------------------------------------------------
    {
      ...
      steps: [
        ...
        { id: 'layer', title: 'Waste on its own layer', kind: 'do',
          rulesExempt: 'no rulebook entry: IPC 1003.3 grease interceptors',
        ...
        { id: 'vents', title: 'Which walls carry a vent stack?', kind: 'do', cardAt: 'bl',
          rulesExempt: 'no rulebook entry: IPC 708 cleanouts, IPC 901 vents',
    ...
    // 5 -------------------------------------------------------------------------------------
    {
      ...
      steps: [
        ...
        { id: 'stack', title: 'Trace the stack', kind: 'do', cardAt: 'br', page: 3, zones: () => traceZones(RE.pvc4, raw(R.stack), K().P601),
          rulesExempt: 'no rulebook entry: IPC Table 1002.2 trap arm length',
        ...
        { id: 'why', title: 'Why the stack keeps going', kind: 'read', cardAt: 'br',
          rulesExempt: 'no rulebook entry: IPC 903 vent terminals',
    ...
    // 6 -------------------------------------------------------------------------------------
    {
      ...
      steps: [
        { id: 'meter', title: 'From the meter', kind: 'read', cardAt: 'tl',
          rulesExempt: 'no rulebook entry: IFGC 402 gas pipe sizing',
        ...
        { id: 'drops', title: 'Count the drops', kind: 'do', cardAt: 'bl', page: 0, zones: () => circlesOn(K().P101, RE.gasDrop, SPOTS().gasDrop, 12),
          rulesExempt: 'no rulebook entry: IFGC 409.5 appliance shutoff valves',
        ...
        { id: 'hangers', title: 'A hanger row of your own', kind: 'do',
          rulesExempt: 'no rulebook entry: IPC Table 308.5 steel pipe hangers (the card says the rulebook has no steel row yet)',
    ...
    // 9 -------------------------------------------------------------------------------------
    {
      ...
      steps: [
        ...
        { id: 'ledger', title: 'Every question in one list', kind: 'do', hold: true,
          body: '1. In the header, click [[Notes ledger]], the page icon; its badge counts the open RFI flags.\nIt lists every note sheet by sheet, the RFI chip at its top narrows it to the flags, and a click on a row takes you to the spot. Read it once before the bid goes out.',
