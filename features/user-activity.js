...
(function() {
  ...
  // App.openUserActivityModal at call time. The rich per-user OVERVIEW modal
  // (openUserActivityOverview) lives in features/user-activity-overview.js
  // (split at this file's documented domain seam — zero shared symbols).
