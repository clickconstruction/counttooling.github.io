...
| D23 | X1 zone handles: in Move, scale/multiply zones drag to move and corner-drag to resize (cursor swap only), live re-tally, one undo snapshot; hitTest rung after T2-03's hideMarks return; coexists with the 280 ms aim loupe (T2-10 rule) | claude/duct-d23-zone-handles | queued — **push after** |
