...
| D21 | J5-D: trade-aware strip (profile seeds which drawing tools sit inline vs behind ⋯) + per-tool "Pin to strip" in the ⋯ menu, remembered per project; the strip never shifts on its own | claude/duct-d21-strip | queued — **push after** |
