...
| D22 | X2 mobile peek: "Show all layers" row in the phone layers menu (only when a page has 2+ layers), toggling the existing showAllCanvases; menu title "Canvases" → "Layers" | claude/duct-d22-mobile-peek | queued |
