...
function tourSources() {
  return ['features/tutorial.js'].concat(['features/lessons.js', 'features/course-plumbing.js', 'features/course-electrical.js'].filter((f) => fs.existsSync(path.join(ROOT, f))));
}
